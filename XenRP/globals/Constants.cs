...
namespace XenRP.globals {
    public class Constants {
        ...
        public static List<InteriorModel> INTERIOR_LIST = new List<InteriorModel> {
            new InteriorModel(GenRes.townhall, new Vector3(-329.399f, 6153.957f, 32.3133f),
                new Vector3(-141.1987f, -620.913f, 168.8205f), "ex_dt1_02_office_02b", 498, GenRes.townhall),
            new InteriorModel(GenRes.hospital, new Vector3(1838.892f, 3673.627f, 34.27668f),
                new Vector3(275.446f, -1361.11f, 24.5378f), "Coroner_Int_On", 153, GenRes.hospital),
            new InteriorModel(GenRes.driving_school, new Vector3(-227.6895f, 6333.742f, 32.41962f),
                new Vector3(-227.6895f, 6333.742f, 32.41962f), string.Empty, 269, GenRes.driving_school),
            new InteriorModel(GenRes.weazel_news, new Vector3(-598.51, -929.95, 23.87),
                new Vector3(-1082.433f, -258.7667f, 37.76331f), "facelobby", 459, GenRes.weazel_news)
        };
        ...
        public static List<BusinessIplModel> BUSINESS_IPL_LIST = new List<BusinessIplModel> {
            ...
            new BusinessIplModel(BUSINESS_TYPE_ELECTRONICS,
                "ex_exec_warehouse_placement_interior_2_int_warehouse_l_dlc_milo",
                new Vector3(1026.751f, -3101.307f, -38.99986f)),
            ...
            new BusinessIplModel(BUSINESS_TYPE_JEWELRY, "post_hiest_unload",
                new Vector3(-630.4483f, -236.8936f, 38.05701f)),
            new BusinessIplModel(BUSINESS_TYPE_PRIVATE_OFFICE, "v_psycheoffice",
                new Vector3(-1906.785f, -573.757f, 19.077f)),
            new BusinessIplModel(BUSINESS_TYPE_CLUBHOUSE, "bkr_bi_hw1_13_int",
                new Vector3(982.4059f, -100.1532f, 74.84502f)),
            new BusinessIplModel(BUSINESS_TYPE_GAS_STATION, "ipl_supermarket",
                new Vector3(-710.1048f, -914.5465f, 19.21559f)),
            new BusinessIplModel(BUSINESS_TYPE_SLAUGHTERHOUSE, "ipl_slaughterhouse",
                new Vector3(964.3511f, -2185.115f, 30.30081f)),
            new BusinessIplModel(BUSINESS_TYPE_BARBER_SHOP, "barber_shop",
                new Vector3(133.9966f, -1710.311f, 29.29162f)),
            new BusinessIplModel(BUSINESS_TYPE_FACTORY, "id2_14_during1", new Vector3(717.0f, -975.0f, 25.0f)),
            new BusinessIplModel(BUSINESS_TYPE_TORTURE_ROOM, "v_torture",
                new Vector3(135.7002f, -2203.643f, 7.309135f)),
            new BusinessIplModel(BUSINESS_TYPE_GARAGE_LOW_END, "low_end_garage_no_ipl",
                new Vector3(178.8302f, -1000.515f, -98.99998f)),
            new BusinessIplModel(BUSINESS_TYPE_WAREHOUSE_MEDIUM,
                "ex_exec_warehouse_placement_interior_0_int_warehouse_m_dlc_milo",
                new Vector3(1048.286f, -3096.858f, -38.99991f)),
            new BusinessIplModel(BUSINESS_TYPE_SOCIAL_CLUB, "house_no_ipl_a",
                new Vector3(265.9776f, -1006.97f, -100.8839f)),
            new BusinessIplModel(BUSINESS_TYPE_TATTOO_SHOP, "business_no_ipl",
                new Vector3(-1154.249f, -1424.721f, 4.954462f)),
            new BusinessIplModel(BUSINESS_TYPE_BENNYS_WHORKSHOP, "business_no_ipl2",
                new Vector3(-205.4454f, -1312.916f, 31.13982f)),
            new BusinessIplModel(BUSINESS_TYPE_MECHANIC, "v_chopshop", new Vector3(481.9714f, -1313.103f, 29.20123f)),
            new BusinessIplModel(BUSINESS_TYPE_VANILLA, "vanilla_no_ipl",
                new Vector3(128.9892f, -1296.068f, 29.26953f)),
            new BusinessIplModel(BUSINESS_TYPE_FISHING,
                "ex_exec_warehouse_placement_interior_0_int_warehouse_m_dlc_milo",
                new Vector3(1048.286f, -3096.858f, -38.99991f))
        };
        ...
        public static Dictionary<int, List<string>> JOB_COMMANDS = new Dictionary<int, List<string>> {
            {JOB_FASTFOOD, new List<string> {Commands.COM_ORDERS}}, {
                JOB_THIEF,
                new List<string> {Commands.COM_FORCE, Commands.COM_STEAL, Commands.COM_HOTWIRE, Commands.COM_PAWN}
            },
        ...
        public static List<BusinessItemModel> BUSINESS_ITEM_LIST = new List<BusinessItemModel> {
            // 24-7
            new BusinessItemModel(ItemRes.beer_bottle, ITEM_HASH_BOTTLE_BEER_AM, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 1, 1,
                new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.08f),
            new BusinessItemModel(ItemRes.beer_pack, ITEM_HASH_PACK_BEER_AM, ITEM_TYPE_OPENABLE, 60, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.sandwich, ITEM_HASH_SANDWICH, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 10, 1,
                new Vector3(0.06f, 0.0f, -0.02f), new Vector3(180.0f, 180.0f, 90.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.cigarettes, ITEM_HASH_CIGARRETES_PACK_OPEN, ITEM_TYPE_CONSUMABLE, 8, 0.1f, -2,
                1, new Vector3(0.06f, 0.0f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.cola, ITEM_HASH_CAN_COLA, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 5, 1,
                new Vector3(0.05f, -0.03f, 0.0f), new Vector3(270.0f, 20.0f, -20.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.candy, ITEM_HASH_CANDY, ITEM_TYPE_CONSUMABLE, 4, 0.1f, 3, 1,
                new Vector3(0.05f, -0.010f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.jerrycan, ITEM_HASH_JERRYCAN, ITEM_TYPE_EQUIPABLE, 25, 0.1f, 0, 1,
                new Vector3(0.09f, 0.09f, 0.0f), new Vector3(0.0f, 90.0f, 175.0f), BUSINESS_TYPE_24_7, 0.0f),
            new BusinessItemModel(ItemRes.coffee, ITEM_HASH_CUP_COFFEE, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 5, 1,
                new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_24_7, 0.0f),

            // Oil station
            new BusinessItemModel(ItemRes.jerrycan, ITEM_HASH_JERRYCAN, ITEM_TYPE_EQUIPABLE, 25, 0.1f, 0, 1,
                new Vector3(0.09f, 0.09f, 0.0f), new Vector3(0.0f, 90.0f, 175.0f), BUSINESS_TYPE_GAS_STATION, 0.0f),

            // Electronic store
            new BusinessItemModel(ItemRes.smartphone, ITEM_HASH_TELEPHONE, ITEM_TYPE_EQUIPABLE, 200, 0.1f, 0, 1,
                new Vector3(0.06f, 0.0f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_ELECTRONICS, 0.0f),
            new BusinessItemModel(ItemRes.walkie, ITEM_HASH_WALKIE, ITEM_TYPE_EQUIPABLE, 150, 0.1f, 0, 1,
                new Vector3(0.06f, 0.0f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_ELECTRONICS, 0.0f),
            new BusinessItemModel(ItemRes.camera, ITEM_HASH_CAMERA, ITEM_TYPE_EQUIPABLE, 50, 0.1f, 0, 1,
                new Vector3(0.05f, -0.02f, -0.02f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_ELECTRONICS, 0.0f),

            // Hardware store
            new BusinessItemModel(ItemRes.crowbar, WeaponHash.Crowbar.ToString(), ITEM_TYPE_WEAPON, 60, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.hammer, WeaponHash.Hammer.ToString(), ITEM_TYPE_WEAPON, 50, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.flashlight, WeaponHash.Flashlight.ToString(), ITEM_TYPE_WEAPON, 30, 0.1f, 0,
                1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.hatchet, WeaponHash.Hatchet.ToString(), ITEM_TYPE_WEAPON, 200, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.wrench, WeaponHash.Wrench.ToString(), ITEM_TYPE_WEAPON, 100, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.knucle_duster, WeaponHash.KnuckleDuster.ToString(), ITEM_TYPE_WEAPON, 100,
                0.1f, 0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.knife, WeaponHash.Knife.ToString(), ITEM_TYPE_WEAPON, 250, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.switchblade, WeaponHash.SwitchBlade.ToString(), ITEM_TYPE_WEAPON, 150, 0.1f,
                0, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),
            new BusinessItemModel(ItemRes.bat, WeaponHash.Bat.ToString(), ITEM_TYPE_WEAPON, 50, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_HARDWARE, 0.0f),

            // Bar
            new BusinessItemModel(ItemRes.beer_bottle, ITEM_HASH_BOTTLE_BEER_PISSWASSER, ITEM_TYPE_CONSUMABLE, 10, 0.1f,
                1, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.08f),
            new BusinessItemModel(ItemRes.burger, ITEM_HASH_BURGER, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 20, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.0f),
            new BusinessItemModel(ItemRes.coffee, ITEM_HASH_CUP_COFFEE, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 5, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.0f),
            new BusinessItemModel(ItemRes.cola, ITEM_HASH_CAN_COLA, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 5, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.0f),
            new BusinessItemModel(ItemRes.hotdog, ITEM_HASH_HOTDOG, ITEM_TYPE_CONSUMABLE, 2, 0.1f, 15, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_BAR, 0.0f),

            // Clubhouse
            new BusinessItemModel(ItemRes.beer_bottle, ITEM_HASH_BOTTLE_BEER_PISSWASSER, ITEM_TYPE_CONSUMABLE, 10, 0.1f,
                1, 1, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE, 0.08f),
            new BusinessItemModel(ItemRes.burger, ITEM_HASH_BURGER, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 20, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE, 0.0f),
            new BusinessItemModel(ItemRes.coffee, ITEM_HASH_CUP_COFFEE, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 5, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE, 0.0f),
            new BusinessItemModel(ItemRes.cola, ITEM_HASH_CAN_COLA, ITEM_TYPE_CONSUMABLE, 5, 0.1f, 5, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE, 0.0f),
            new BusinessItemModel(ItemRes.hotdog, ITEM_HASH_HOTDOG, ITEM_TYPE_CONSUMABLE, 2, 0.1f, 15, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLUBHOUSE, 0.0f),
            ...
            // Disco
            new BusinessItemModel(ItemRes.beer_bottle, ITEM_HASH_BOTTLE_BEER_AM, ITEM_TYPE_CONSUMABLE, 10, 0.1f, 1, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(270.0f, 0.0f, 0.0f), BUSINESS_TYPE_DISCO, 0.08f),
            new BusinessItemModel(ItemRes.juice, ITEM_HASH_CUP_JUICE, ITEM_TYPE_CONSUMABLE, 6, 0.1f, 10, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_DISCO, 0.0f),
            new BusinessItemModel(ItemRes.energy_drink, ITEM_HASH_ENERGY_DRINK, ITEM_TYPE_CONSUMABLE, 6, 0.1f, 5, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_DISCO, 0.0f),
            new BusinessItemModel(ItemRes.cava_bottle, ITEM_HASH_BOTTLE_CAVA, ITEM_TYPE_CONSUMABLE, 70, 0.1f, 15, 5,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_DISCO, 0.05f),

            // Ammu-Nation
            new BusinessItemModel(ItemRes.pistol, WeaponHash.Pistol.ToString(), ITEM_TYPE_WEAPON, 2000, 0.1f, 0, 0,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.pistol_ammo, ITEM_HASH_PISTOL_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 300, 0.1f, 0,
                STACK_PISTOL_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.smg_ammo, ITEM_HASH_MACHINEGUN_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 500, 0.1f, 0,
                STACK_MACHINEGUN_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.shotgun_ammo, ITEM_HASH_SHOTGUN_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 400, 0.1f, 0,
                STACK_SHOTGUN_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.rifle_ammo, ITEM_HASH_ASSAULTRIFLE_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 1000,
                0.1f, 0, STACK_ASSAULTRIFLE_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_AMMUNATION, 0.0f),
            new BusinessItemModel(ItemRes.sniper_ammo, ITEM_HASH_SNIPERRIFLE_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 2000,
                0.1f, 0, STACK_SNIPERRIFLE_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_AMMUNATION, 0.0f),

            // Clothes store
            new BusinessItemModel(ItemRes.bat, WeaponHash.Bat.ToString(), ITEM_TYPE_WEAPON, 300, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLOTHES, 0.0f),
            new BusinessItemModel(ItemRes.golf_club, WeaponHash.GolfClub.ToString(), ITEM_TYPE_WEAPON, 250, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_CLOTHES, 0.0f),

            // Fishing store
            new BusinessItemModel(ItemRes.fishing_rod, ITEM_HASH_FISHING_ROD, ITEM_TYPE_EQUIPABLE, 250, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_FISHING, 0.0f),
            new BusinessItemModel(ItemRes.bait, ITEM_HASH_BAIT, ITEM_TYPE_MISC, 10, 0.1f, 0, 10,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_FISHING, 0.0f),

            // Miscellaneous
            new BusinessItemModel(ItemRes.fish, ITEM_HASH_FISH, ITEM_TYPE_MISC, 0, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.products, ITEM_HASH_BUSINESS_PRODUCTS, ITEM_TYPE_MISC, 50, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.stolen_items, ITEM_HASH_STOLEN_OBJECTS, ITEM_TYPE_MISC, 50, 0.1f, 0, 1,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.bullpup_shotgun, WeaponHash.BullpupShotgun.ToString(), ITEM_TYPE_WEAPON, 0,
                0.1f, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.compact_rifle, WeaponHash.CompactRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f,
                0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.carbine_rifle, WeaponHash.CarbineRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f,
                0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.heavy_shotgun, WeaponHash.HeavyShotgun.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f,
                0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.sawn_off_shotgun, WeaponHash.SawnOffShotgun.ToString(), ITEM_TYPE_WEAPON, 0,
                0.1f, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.bullpup_rifle, WeaponHash.BullpupRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f,
                0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.assault_rifle, WeaponHash.AssaultRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f,
                0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.ap_pistol, WeaponHash.APPistol.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.double_barrel_shotgun, WeaponHash.DoubleBarrelShotgun.ToString(),
                ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.machine_pistol, WeaponHash.MachinePistol.ToString(), ITEM_TYPE_WEAPON, 0,
                0.1f, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.sniper_rifle, WeaponHash.SniperRifle.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0,
                0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.assault_smg, WeaponHash.AssaultSMG.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0,
                0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.combat_pdw, WeaponHash.CombatPDW.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.revolver, WeaponHash.Revolver.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.heavy_pistol, WeaponHash.HeavyPistol.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0,
                0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.pump_shotgun, WeaponHash.PumpShotgun.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0,
                0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.special_carbine, WeaponHash.SpecialCarbine.ToString(), ITEM_TYPE_WEAPON, 0,
                0.1f, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.pistol_50, WeaponHash.Pistol50.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.advanced_rifle, WeaponHash.AdvancedRifle.ToString(), ITEM_TYPE_WEAPON, 0,
                0.1f, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.heavy_sniper, WeaponHash.HeavySniper.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0,
                0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.micro_smg, WeaponHash.MicroSMG.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.assault_shotgun, WeaponHash.AssaultShotgun.ToString(), ITEM_TYPE_WEAPON, 0,
                0.1f, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.marksman_rifle, WeaponHash.MarksmanRifle.ToString(), ITEM_TYPE_WEAPON, 0,
                0.1f, 0, 0, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.smg, WeaponHash.SMG.ToString(), ITEM_TYPE_WEAPON, 0, 0.1f, 0, 0,
                new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.pistol_ammo, ITEM_HASH_PISTOL_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f, 0,
                STACK_PISTOL_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f), BUSINESS_TYPE_NONE,
                0.0f),
            new BusinessItemModel(ItemRes.smg_ammo, ITEM_HASH_MACHINEGUN_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f, 0,
                STACK_MACHINEGUN_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.shotgun_ammo, ITEM_HASH_SHOTGUN_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f, 0,
                STACK_SHOTGUN_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.rifle_ammo, ITEM_HASH_ASSAULTRIFLE_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f,
                0, STACK_ASSAULTRIFLE_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_NONE, 0.0f),
            new BusinessItemModel(ItemRes.sniper_ammo, ITEM_HASH_SNIPERRIFLE_AMMO_CLIP, ITEM_TYPE_AMMUNITION, 0, 0.1f,
                0, STACK_SNIPERRIFLE_CAPACITY, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f),
                BUSINESS_TYPE_NONE, 0.0f)
        };
        ...
        public static List<BusinessClothesModel> BUSINESS_CLOTHES_LIST = new List<BusinessClothesModel> {
            ...
            new BusinessClothesModel(0, "interior encaje blanca con liguero y media", CLOTHES_LEGS, 20, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "interior blanco y legro con liguero y medias", CLOTHES_LEGS, 63, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Converse amarillo y blanco calentadores negros", CLOTHES_FEET, 33, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Deportivas negra con rayas amarillo fosforito", CLOTHES_FEET, 58, SEX_FEMALE,
                150),
            ...
            // Male shoes
            new BusinessClothesModel(0, "Zapatillas cuadros negros y blancos tobillo alto", CLOTHES_FEET, 0, SEX_MALE,
                150),
            new BusinessClothesModel(0, "Zapatillas negra suela blanca", CLOTHES_FEET, 1, SEX_MALE, 150),
            new BusinessClothesModel(0, "Zapatillas cuadros negros y blancos tobillo bajo", CLOTHES_FEET, 2, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Zapatillas blanca puntos negros tobillo alto", CLOTHES_FEET, 28, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Pulseras anchas mano derecha cuadrados negro y blanco", CLOTHES_ACCESSORIES, 4,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Muñequera mano derecha cuadrados negro y blanco", CLOTHES_ACCESSORIES, 5,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Colgante herradura dorada gema interior oscura", CLOTHES_ACCESSORIES, 6,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Colgantes cuerdas negra y dorado con circulo y corazon dorado",
                CLOTHES_ACCESSORIES, 7, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Palestina negra y blanca", CLOTHES_ACCESSORIES, 9, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Pulseras anchas mano derecha flores", CLOTHES_ACCESSORIES, 10, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Colgantes cuarda negra y dorado con circulo dorado y corazon oscuro",
                CLOTHES_ACCESSORIES, 11, SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Muñequera mano derecha tachuelas metal", CLOTHES_ACCESSORIES, 14, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Cadena oro colgante calavera oro ojos rojos", CLOTHES_ACCESSORIES, 30,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Cadena plata colgante calavera plata ojos rojos", CLOTHES_ACCESSORIES, 31,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Cadena oro colgante calavera ojos rojos exterior", CLOTHES_ACCESSORIES, 37,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Cadena plata colgante enmascarado plata exterior", CLOTHES_ACCESSORIES, 38,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Cadena oro colgante placa plata exterior", CLOTHES_ACCESSORIES, 39, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Cadena oro colgante letras oro exterior", CLOTHES_ACCESSORIES, 42, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Cadena oro colgante estrella roja y dorada exterior", CLOTHES_ACCESSORIES, 90,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Cadena oro colgante estrella dorada exterior", CLOTHES_ACCESSORIES, 92,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Cadena oro colgante estrella rojo exterior", CLOTHES_ACCESSORIES, 121,
                SEX_MALE, 150),
            new BusinessClothesModel(0, "Cadena oro colgante estrella oro exterior", CLOTHES_ACCESSORIES, 122, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Chaqueta corta amarilla y blanca remangada", CLOTHES_TOPS, 35, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Camisa cuadritos veig, amarillo, marron y negro remangada", CLOTHES_TOPS, 71,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Camiseta amarilla y negra por dentro del pantalon", CLOTHES_TOPS, 75,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS por dentro del pantalon", CLOTHES_TOPS, 85,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Chaqueta oscura con flores marrones abierta", CLOTHES_TOPS, 94, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Chaqueta oscura con flores marrones cerrada", CLOTHES_TOPS, 95, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Camisa blanca cerrada con bolsillos grandes", CLOTHES_TOPS, 98, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro del pantalon", CLOTHES_TOPS, 103,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Camiseta blanca sin manga por dentro del pantalon", CLOTHES_TOPS, 117,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Camisa de cuadros negro y azulado abierto", CLOTHES_TOPS, 120, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Camisa de cuadros negro y azulado cerrado", CLOTHES_TOPS, 121, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Polo azul LIBERTY por dentro de pantalones", CLOTHES_TOPS, 129, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Jersey sin mangas rombos negros gris y blanco", CLOTHES_TOPS, 134, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Chaqueta marron oscuro con cinturon", CLOTHES_TOPS, 135, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro de pantalones", CLOTHES_TOPS, 136,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Camisa abierta oscura con letras amarillas", CLOTHES_TOPS, 148, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Chaquetilla sin mangas negra con cremallera", CLOTHES_TOPS, 155, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Chaquetilla negra sin mangas con botones", CLOTHES_TOPS, 156, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chaquetilla negra sin mangas abierta cremallera", CLOTHES_TOPS, 157,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chaqueta de cuero negra cerrada", CLOTHES_TOPS, 158, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chaqueta de cuero negra sin mangas cerrada", CLOTHES_TOPS, 159, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Chaqueta azul oscuro manga serpiente blanco", CLOTHES_TOPS, 162, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Chaqueta vaquera sin mangas pegatina abierta", CLOTHES_TOPS, 175, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Chaqueta cuero negra pegatinas cerrada", CLOTHES_TOPS, 176, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chaqueta cuero negra pegatinas sin mangas", CLOTHES_TOPS, 177, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta manga larga negra con rayas amarillas", CLOTHES_TOPS, 180, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Chubasquero verde largo con capucha abierto", CLOTHES_TOPS, 187, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta ajustada negra con rayas amarillas celestes verdes y rosa",
                CLOTHES_TOPS, 203, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta sin manga negra con capucha puesta", CLOTHES_TOPS, 204, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Sudadera amarilla parches naranjas con capucha puesta", CLOTHES_TOPS, 205,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Gabardina negra con capucha puesta", CLOTHES_TOPS, 206, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta sin mangas negra con cuello ancho", CLOTHES_TOPS, 207, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Camiseta camuflaje sin mangas por dentro del pantalon", CLOTHES_TOPS, 208,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta camuflaje sin mangas", CLOTHES_TOPS, 209, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas con capucha", CLOTHES_TOPS, 210,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas capucha puesta", CLOTHES_TOPS, 211,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado metida por pantalon", CLOTHES_TOPS, 212, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado con capucha", CLOTHES_TOPS, 214, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado con capucha puesta", CLOTHES_TOPS, 215,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado abierto", CLOTHES_TOPS, 216, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta sin mangas negro y camuflaje azulado", CLOTHES_TOPS, 217, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Camiseta manga larga negra con camuflaje azulado", CLOTHES_TOPS, 218,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado y negro abierta", CLOTHES_TOPS, 219, SEX_FEMALE,
                150),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado y negro sin mangas abierta", CLOTHES_TOPS, 220,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas recogido ", CLOTHES_TOPS, 221,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Camiseta camuflaje azulado por dentro del pantalon", CLOTHES_TOPS, 224,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta sin mangas camuflaje azulado", CLOTHES_TOPS, 225, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta sin mangas camuflaje azulado metido por pantalon", CLOTHES_TOPS, 226,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chubasquero marron largo cerrado", CLOTHES_TOPS, 227, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chubasquero marron largo cerrado capucha puesta", CLOTHES_TOPS, 228,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chaquetilla camuflaje azulado sin manga", CLOTHES_TOPS, 229, SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Sudadera azul y camuflaje azulado mangas largas", CLOTHES_TOPS, 230,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(0, "Chaqueta sin mangas cerrada por cremallera negra", CLOTHES_TOPS, 233,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Chaqueta negra con mangas largas cerrada con cremallera", CLOTHES_TOPS, 234,
                SEX_FEMALE, 150),
            new BusinessClothesModel(0, "Camiseta blanca y mangas azules con letras", CLOTHES_TOPS, 235, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta manga larga negra por dentro del pantalon", CLOTHES_TOPS, 53,
                SEX_MALE, 150),
            ...
            new BusinessClothesModel(0, "Camiseta cortada por abajo roja y manga negra", CLOTHES_TOPS, 66, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS por dentro del pantalon", CLOTHES_TOPS, 94, SEX_MALE,
                150),
            new BusinessClothesModel(0, "Camisa vaquera remangada por dentro del pantalon", CLOTHES_TOPS, 95, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta manga larga marron por dentro del pantalon", CLOTHES_TOPS, 98,
                SEX_MALE, 150),
            ...
            new BusinessClothesModel(0, "Chaqueta marron motivos marron claro abierta", CLOTHES_TOPS, 103, SEX_MALE,
                150),
            new BusinessClothesModel(0, "Chaqueta marron motivos marron claro escote", CLOTHES_TOPS, 104, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro del pantalon", CLOTHES_TOPS, 111,
                SEX_MALE, 150),
            ...
            new BusinessClothesModel(0, "Camisa escote blanca por dentro de pantalon", CLOTHES_TOPS, 114, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Chaqueta negra triangulo rojo y blanco abierta", CLOTHES_TOPS, 130, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Camisa remangada marron claro por dentro de pantalon", CLOTHES_TOPS, 133,
                SEX_MALE, 150),
            ...
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro de pantalon", CLOTHES_TOPS, 139, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta negra manga larga dibujos amarillos rojos y celeste", CLOTHES_TOPS,
                201, SEX_MALE, 150),
            new BusinessClothesModel(0, "Camiseta negra sin manga con capucha puesta", CLOTHES_TOPS, 202, SEX_MALE,
                150),
            new BusinessClothesModel(0, "Sudadera amarilla parche naranja capucha puesta", CLOTHES_TOPS, 203, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta sin manga camuflaje azul capucha puesta", CLOTHES_TOPS, 207, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(0, "Camiseta larga azul camuflaje capucha puesta", CLOTHES_TOPS, 211, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(1, "Casco negro rayas amarillas visera abierta", ACCESSORY_HATS, 91, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(1, "Gorra hacia atras cuadrados negros y blancos", ACCESSORY_HATS, 9, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(1, "Casco negro rayas amarillas visera abierta", ACCESSORY_HATS, 92, SEX_MALE,
                150),
            ...
            new BusinessClothesModel(1, "Redonda con picos superiores marron oscuro", ACCESSORY_GLASSES, 2, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(1, "Vista pasta negra cristal transparente", ACCESSORY_GLASSES, 14, SEX_FEMALE,
                150),
            ...
            new BusinessClothesModel(1, "Redondas negras cristal transparente oscuro", ACCESSORY_GLASSES, 20,
                SEX_FEMALE, 150),
            ...
            new BusinessClothesModel(1, "Finas negras cristal transparente oscuro", ACCESSORY_GLASSES, 3, SEX_MALE,
                150),
        ...
        public static List<BusinessTattooModel> TATTOO_LIST = new List<BusinessTattooModel> {
            // Torso
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Refined Hustler", "mpbusiness_overlays",
                "MP_Buis_M_Stomach_000", string.Empty, 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Rich", "mpbusiness_overlays", "MP_Buis_M_Chest_000",
                string.Empty, 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "$$$", "mpbusiness_overlays", "MP_Buis_M_Chest_001",
                string.Empty, 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Makin' Paper", "mpbusiness_overlays", "MP_Buis_M_Back_000",
                string.Empty, 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "High Roller", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Chest_000", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Makin' Money", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Chest_001", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Love Money", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Chest_002", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Diamond Back", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Stom_000", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Santo Capra Logo", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Stom_001", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Money Bag", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Stom_002", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Respect", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Back_000", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Gold Digger", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Back_001", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Carp Outline", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_005",
                "MP_Xmas2_F_Tat_005", 230),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Carp Shaded", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_006",
                "MP_Xmas2_F_Tat_006", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Time To Die", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_009",
                "MP_Xmas2_F_Tat_009", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Roaring Tiger", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_011",
                "MP_Xmas2_F_Tat_011", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Lizard", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_013",
                "MP_Xmas2_F_Tat_013", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Japanese Warrior", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_015", "MP_Xmas2_F_Tat_015", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Loose Lips Outline", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_016", "MP_Xmas2_F_Tat_016", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Loose Lips Color", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_017", "MP_Xmas2_F_Tat_017", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Royal Dagger Outline", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_018", "MP_Xmas2_F_Tat_018", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Royal Dagger Color", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_019", "MP_Xmas2_F_Tat_019", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Executioner", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_028",
                "MP_Xmas2_F_Tat_028", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Bullet Proof", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_000_M", "MP_Gunrunning_Tattoo_000_F", 320),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Crossed Weapons", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_001_M", "MP_Gunrunning_Tattoo_001_F", 320),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Butterfly Knife", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_009_M", "MP_Gunrunning_Tattoo_009_F", 320),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Cash Money", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_010_M", "MP_Gunrunning_Tattoo_010_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Dollar Daggers", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_012_M", "MP_Gunrunning_Tattoo_012_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Wolf Insignia", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_013_M", "MP_Gunrunning_Tattoo_013_F", 450),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Backstabber", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_014_M", "MP_Gunrunning_Tattoo_014_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Dog Tags", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_017_M", "MP_Gunrunning_Tattoo_017_F", 120),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Dual Wield Skull", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_018_M", "MP_Gunrunning_Tattoo_018_F", 270),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Pistol Wings", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_019_M", "MP_Gunrunning_Tattoo_019_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Crowned Weapons", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_020_M", "MP_Gunrunning_Tattoo_020_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Explosive Heart", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_022_M", "MP_Gunrunning_Tattoo_022_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Micro SMG Chain", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_028_M", "MP_Gunrunning_Tattoo_028_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Win Some Lose Some", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_029_M", "MP_Gunrunning_Tattoo_029_F", 280),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Crossed Arrows", "mphipster_overlays", "FM_Hip_M_Tat_000",
                "FM_Hip_F_Tat_000", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Chemistry", "mphipster_overlays", "FM_Hip_M_Tat_002",
                "FM_Hip_F_Tat_002", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Feather Birds", "mphipster_overlays", "FM_Hip_M_Tat_006",
                "FM_Hip_F_Tat_006", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Infinity", "mphipster_overlays", "FM_Hip_M_Tat_011",
                "FM_Hip_F_Tat_011", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Antlers", "mphipster_overlays", "FM_Hip_M_Tat_012",
                "FM_Hip_F_Tat_012", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Boombox", "mphipster_overlays", "FM_Hip_M_Tat_013",
                "FM_Hip_F_Tat_013", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Pyramid", "mphipster_overlays", "FM_Hip_M_Tat_024",
                "FM_Hip_F_Tat_024", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Watch Your Step", "mphipster_overlays", "FM_Hip_M_Tat_025",
                "FM_Hip_F_Tat_025", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Sad", "mphipster_overlays", "FM_Hip_M_Tat_029",
                "FM_Hip_F_Tat_029", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Shark Fin", "mphipster_overlays", "FM_Hip_M_Tat_030",
                "FM_Hip_F_Tat_030", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Skateboard", "mphipster_overlays", "FM_Hip_M_Tat_031",
                "FM_Hip_F_Tat_031", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Paper Plane", "mphipster_overlays", "FM_Hip_M_Tat_032",
                "FM_Hip_F_Tat_032", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Stag", "mphipster_overlays", "FM_Hip_M_Tat_033",
                "FM_Hip_F_Tat_033", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Sewn Heart", "mphipster_overlays", "FM_Hip_M_Tat_035",
                "FM_Hip_F_Tat_035", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Tooth", "mphipster_overlays", "FM_Hip_M_Tat_041",
                "FM_Hip_F_Tat_041", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Triangles", "mphipster_overlays", "FM_Hip_M_Tat_046",
                "FM_Hip_F_Tat_046", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Cassette", "mphipster_overlays", "FM_Hip_M_Tat_047",
                "FM_Hip_F_Tat_047", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Block Back", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_000_M", "MP_MP_ImportExport_Tat_000_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Power Plant", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_001_M", "MP_MP_ImportExport_Tat_001_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Tuned to Death", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_002_M", "MP_MP_ImportExport_Tat_002_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Serpents of Destruction", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_009_M", "MP_MP_ImportExport_Tat_009_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Take the Wheel", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_010_M", "MP_MP_ImportExport_Tat_010_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Talk Shit Get Hit", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_011_M", "MP_MP_ImportExport_Tat_011_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "King Fight", "mplowrider_overlays", "MP_LR_Tat_001_M",
                "MP_LR_Tat_001_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Holy Mary", "mplowrider_overlays", "MP_LR_Tat_002_M",
                "MP_LR_Tat_002_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Gun Mic", "mplowrider_overlays", "MP_LR_Tat_004_M",
                "MP_LR_Tat_004_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Amazon", "mplowrider_overlays", "MP_LR_Tat_009_M",
                "MP_LR_Tat_009_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Bad Angel", "mplowrider_overlays", "MP_LR_Tat_010_M",
                "MP_LR_Tat_010_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Love Gamble", "mplowrider_overlays", "MP_LR_Tat_013_M",
                "MP_LR_Tat_013_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Love is Blind", "mplowrider_overlays", "MP_LR_Tat_014_M",
                "MP_LR_Tat_014_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Sad Angel", "mplowrider_overlays", "MP_LR_Tat_021_M",
                "MP_LR_Tat_021_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Royal Takeover", "mplowrider_overlays", "MP_LR_Tat_026_M",
                "MP_LR_Tat_026_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Turbulence", "mpairraces_overlays", "MP_Airraces_Tattoo_000_M",
                "MP_Airraces_Tattoo_000_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Pilot Skull", "mpairraces_overlays", "MP_Airraces_Tattoo_001_M",
                "MP_Airraces_Tattoo_001_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Winged Bombshell", "mpairraces_overlays",
                "MP_Airraces_Tattoo_002_M", "MP_Airraces_Tattoo_002_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Balloon Pioneer", "mpairraces_overlays",
                "MP_Airraces_Tattoo_004_M", "MP_Airraces_Tattoo_004_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Parachute Belle", "mpairraces_overlays",
                "MP_Airraces_Tattoo_005_M", "MP_Airraces_Tattoo_005_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Bombs Away", "mpairraces_overlays", "MP_Airraces_Tattoo_006_M",
                "MP_Airraces_Tattoo_006_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Eagle Eyes", "mpairraces_overlays", "MP_Airraces_Tattoo_007_M",
                "MP_Airraces_Tattoo_007_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Demon Rider", "mpbiker_overlays", "MP_MP_Biker_Tat_000_M",
                "MP_MP_Biker_Tat_000_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Both Barrels", "mpbiker_overlays", "MP_MP_Biker_Tat_001_M",
                "MP_MP_Biker_Tat_001_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Web Rider", "mpbiker_overlays", "MP_MP_Biker_Tat_003_M",
                "MP_MP_Biker_Tat_003_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Made In America", "mpbiker_overlays", "MP_MP_Biker_Tat_005_M",
                "MP_MP_Biker_Tat_005_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Chopper Freedom", "mpbiker_overlays", "MP_MP_Biker_Tat_006_M",
                "MP_MP_Biker_Tat_006_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Freedom Wheels", "mpbiker_overlays", "MP_MP_Biker_Tat_008_M",
                "MP_MP_Biker_Tat_008_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Skull Of Taurus", "mpbiker_overlays", "MP_MP_Biker_Tat_010_M",
                "MP_MP_Biker_Tat_010_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "R.I.P. My Brothers", "mpbiker_overlays",
                "MP_MP_Biker_Tat_011_M", "MP_MP_Biker_Tat_011_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Demon Crossbones", "mpbiker_overlays", "MP_MP_Biker_Tat_013_M",
                "MP_MP_Biker_Tat_013_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Clawed Beast", "mpbiker_overlays", "MP_MP_Biker_Tat_017_M",
                "MP_MP_Biker_Tat_017_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Skeletal Chopper", "mpbiker_overlays", "MP_MP_Biker_Tat_018_M",
                "MP_MP_Biker_Tat_018_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Gruesome Talons", "mpbiker_overlays", "MP_MP_Biker_Tat_019_M",
                "MP_MP_Biker_Tat_019_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Flaming Reaper", "mpbiker_overlays", "MP_MP_Biker_Tat_021_M",
                "MP_MP_Biker_Tat_021_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Western MC", "mpbiker_overlays", "MP_MP_Biker_Tat_023_M",
                "MP_MP_Biker_Tat_023_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "American Dream", "mpbiker_overlays", "MP_MP_Biker_Tat_026_M",
                "MP_MP_Biker_Tat_026_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Bone Wrench", "mpbiker_overlays", "MP_MP_Biker_Tat_029_M",
                "MP_MP_Biker_Tat_029_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Brothers For Life", "mpbiker_overlays", "MP_MP_Biker_Tat_030_M",
                "MP_MP_Biker_Tat_030_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Gear Head", "mpbiker_overlays", "MP_MP_Biker_Tat_031_M",
                "MP_MP_Biker_Tat_031_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Western Eagle", "mpbiker_overlays", "MP_MP_Biker_Tat_032_M",
                "MP_MP_Biker_Tat_032_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Brotherhood of Bikes", "mpbiker_overlays",
                "MP_MP_Biker_Tat_034_M", "MP_MP_Biker_Tat_034_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Gas Guzzler", "mpbiker_overlays", "MP_MP_Biker_Tat_039_M",
                "MP_MP_Biker_Tat_039_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "No Regrets", "mpbiker_overlays", "MP_MP_Biker_Tat_041_M",
                "MP_MP_Biker_Tat_041_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Ride Forever", "mpbiker_overlays", "MP_MP_Biker_Tat_043_M",
                "MP_MP_Biker_Tat_043_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Unforgiven", "mpbiker_overlays", "MP_MP_Biker_Tat_050_M",
                "MP_MP_Biker_Tat_050_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Biker Mount", "mpbiker_overlays", "MP_MP_Biker_Tat_052_M",
                "MP_MP_Biker_Tat_052_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Reaper Vulture", "mpbiker_overlays", "MP_MP_Biker_Tat_058_M",
                "MP_MP_Biker_Tat_058_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Faggio", "mpbiker_overlays", "MP_MP_Biker_Tat_059_M",
                "MP_MP_Biker_Tat_059_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "We Are The Mods!", "mpbiker_overlays", "MP_MP_Biker_Tat_060_M",
                "MP_MP_Biker_Tat_060_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "SA Assault", "mplowrider2_overlays", "MP_LR_Tat_000_M",
                "MP_LR_Tat_000_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Love the Game", "mplowrider2_overlays", "MP_LR_Tat_008_M",
                "MP_LR_Tat_008_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Lady Liberty", "mplowrider2_overlays", "MP_LR_Tat_011_M",
                "MP_LR_Tat_011_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Royal Kiss", "mplowrider2_overlays", "MP_LR_Tat_012_M",
                "MP_LR_Tat_012_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Two Face", "mplowrider2_overlays", "MP_LR_Tat_016_M",
                "MP_LR_Tat_016_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Death Behind", "mplowrider2_overlays", "MP_LR_Tat_019_M",
                "MP_LR_Tat_019_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Dead Pretty", "mplowrider2_overlays", "MP_LR_Tat_031_M",
                "MP_LR_Tat_031_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Reign Over", "mplowrider2_overlays", "MP_LR_Tat_032_M",
                "MP_LR_Tat_032_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Abstract Skull", "mpluxe_overlays", "MP_LUXE_TAT_003_M",
                "MP_LUXE_TAT_003_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Eye of the Griffin", "mpluxe_overlays", "MP_LUXE_TAT_007_M",
                "MP_LUXE_TAT_007_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Flying Eye", "mpluxe_overlays", "MP_LUXE_TAT_008_M",
                "MP_LUXE_TAT_008_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Ancient Queen", "mpluxe_overlays", "MP_LUXE_TAT_014_M",
                "MP_LUXE_TAT_014_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Smoking Sisters", "mpluxe_overlays", "MP_LUXE_TAT_015_M",
                "MP_LUXE_TAT_015_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Feather Mural", "mpluxe_overlays", "MP_LUXE_TAT_024_M",
                "MP_LUXE_TAT_024_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "The Howler", "mpluxe2_overlays", "MP_LUXE_TAT_002_M",
                "MP_LUXE_TAT_002_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Geometric Galaxy", "mpluxe2_overlays", "MP_LUXE_TAT_012_M",
                "MP_LUXE_TAT_012_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Cloaked Angel", "mpluxe2_overlays", "MP_LUXE_TAT_022_M",
                "MP_LUXE_TAT_022_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Reaper Sway", "mpluxe2_overlays", "MP_LUXE_TAT_025_M",
                "MP_LUXE_TAT_025_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Cobra Dawn", "mpluxe2_overlays", "MP_LUXE_TAT_027_M",
                "MP_LUXE_TAT_027_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Geometric Design", "mpluxe2_overlays", "MP_LUXE_TAT_029_M",
                "MP_LUXE_TAT_029_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Bless The Dead", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_000_M", "MP_Smuggler_Tattoo_000_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Dead Lies", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_002_M",
                "MP_Smuggler_Tattoo_002_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Give Nothing Back", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_003_M", "MP_Smuggler_Tattoo_003_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Never Surrender", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_006_M", "MP_Smuggler_Tattoo_006_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "No Honor", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_007_M",
                "MP_Smuggler_Tattoo_007_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Tall Ship Conflict", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_009_M", "MP_Smuggler_Tattoo_009_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "See You In Hell", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_010_M", "MP_Smuggler_Tattoo_010_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Torn Wings", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_013_M",
                "MP_Smuggler_Tattoo_013_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Jolly Roger", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_015_M",
                "MP_Smuggler_Tattoo_015_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Skull Compass", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_016_M", "MP_Smuggler_Tattoo_016_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Framed Tall Ship", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_017_M", "MP_Smuggler_Tattoo_017_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Finders Keepers", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_018_M", "MP_Smuggler_Tattoo_018_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Lost At Sea", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_019_M",
                "MP_Smuggler_Tattoo_019_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Dead Tales", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_021_M",
                "MP_Smuggler_Tattoo_021_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "X Marks The Spot", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_022_M", "MP_Smuggler_Tattoo_022_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Pirate Captain", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_024_M", "MP_Smuggler_Tattoo_024_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Claimed By The Beast", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_025_M", "MP_Smuggler_Tattoo_025_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Wheels of Death", "mpstunt_overlays", "MP_MP_Stunt_Tat_011_M",
                "MP_MP_Stunt_Tat_011_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Punk Biker", "mpstunt_overlays", "MP_MP_Stunt_Tat_012_M",
                "MP_MP_Stunt_Tat_012_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Bat Cat of Spades", "mpstunt_overlays", "MP_MP_Stunt_Tat_014_M",
                "MP_MP_Stunt_Tat_014_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Vintage Bully", "mpstunt_overlays", "MP_MP_Stunt_Tat_018_M",
                "MP_MP_Stunt_Tat_018_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Engine Heart", "mpstunt_overlays", "MP_MP_Stunt_Tat_019_M",
                "MP_MP_Stunt_Tat_019_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Road Kill", "mpstunt_overlays", "MP_MP_Stunt_Tat_024_M",
                "MP_MP_Stunt_Tat_024_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Winged Wheel", "mpstunt_overlays", "MP_MP_Stunt_Tat_026_M",
                "MP_MP_Stunt_Tat_026_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Punk Road Hog", "mpstunt_overlays", "MP_MP_Stunt_Tat_027_M",
                "MP_MP_Stunt_Tat_027_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Majestic Finish", "mpstunt_overlays", "MP_MP_Stunt_Tat_029_M",
                "MP_MP_Stunt_Tat_029_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Man's Ruin", "mpstunt_overlays", "MP_MP_Stunt_Tat_030_M",
                "MP_MP_Stunt_Tat_030_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Sugar Skull Trucker", "mpstunt_overlays",
                "MP_MP_Stunt_Tat_033_M", "MP_MP_Stunt_Tat_033_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Feather Road Kill", "mpstunt_overlays", "MP_MP_Stunt_Tat_034_M",
                "MP_MP_Stunt_Tat_034_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Big Grills", "mpstunt_overlays", "MP_MP_Stunt_Tat_037_M",
                "MP_MP_Stunt_Tat_037_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Monkey Chopper", "mpstunt_overlays", "MP_MP_Stunt_Tat_040_M",
                "MP_MP_Stunt_Tat_040_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Brapp", "mpstunt_overlays", "MP_MP_Stunt_Tat_041_M",
                "MP_MP_Stunt_Tat_041_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Ram Skull", "mpstunt_overlays", "MP_MP_Stunt_Tat_044_M",
                "MP_MP_Stunt_Tat_044_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Full Throttle", "mpstunt_overlays", "MP_MP_Stunt_Tat_046_M",
                "MP_MP_Stunt_Tat_046_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Racing Doll", "mpstunt_overlays", "MP_MP_Stunt_Tat_048_M",
                "MP_MP_Stunt_Tat_048_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Blackjack", "multiplayer_overlays", "FM_Tat_Award_M_003",
                "FM_Tat_Award_F_003", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Hustler", "multiplayer_overlays", "FM_Tat_Award_M_004",
                "FM_Tat_Award_F_004", 300),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Angel", "multiplayer_overlays", "FM_Tat_Award_M_005",
                "FM_Tat_Award_F_005", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Los Santos Customs", "multiplayer_overlays",
                "FM_Tat_Award_M_008", "FM_Tat_Award_F_008", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Blank Scroll", "multiplayer_overlays", "FM_Tat_Award_M_011",
                "FM_Tat_Award_F_011", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Embellished Scroll", "multiplayer_overlays",
                "FM_Tat_Award_M_012", "FM_Tat_Award_F_012", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Seven Deadly Sins", "multiplayer_overlays",
                "FM_Tat_Award_M_013", "FM_Tat_Award_F_013", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Trust No One", "multiplayer_overlays", "FM_Tat_Award_M_014",
                "FM_Tat_Award_F_014", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Clown", "multiplayer_overlays", "FM_Tat_Award_M_016",
                "FM_Tat_Award_F_016", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Clown and Gun", "multiplayer_overlays", "FM_Tat_Award_M_017",
                "FM_Tat_Award_F_017", 220),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Clown Dual Wield", "multiplayer_overlays", "FM_Tat_Award_M_018",
                "FM_Tat_Award_F_018", 240),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Clown Dual Wield Dollars", "multiplayer_overlays",
                "FM_Tat_Award_M_019", "FM_Tat_Award_F_019", 260),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Faith", "multiplayer_overlays", "FM_Tat_M_004", "FM_Tat_F_004",
                350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Skull on the Cross", "multiplayer_overlays", "FM_Tat_M_009",
                "FM_Tat_F_009", 400),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "LS Flames", "multiplayer_overlays", "FM_Tat_M_010",
                "FM_Tat_F_010", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "LS Script", "multiplayer_overlays", "FM_Tat_M_011",
                "FM_Tat_F_011", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Los Santos Bills", "multiplayer_overlays", "FM_Tat_M_012",
                "FM_Tat_F_012", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Eagle and Serpent", "multiplayer_overlays", "FM_Tat_M_013",
                "FM_Tat_F_013", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Evil Clown", "multiplayer_overlays", "FM_Tat_M_016",
                "FM_Tat_F_016", 450),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "The Wages of Sin", "multiplayer_overlays", "FM_Tat_M_019",
                "FM_Tat_F_019", 450),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Dragon", "multiplayer_overlays", "FM_Tat_M_020", "FM_Tat_F_020",
                420),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Flaming Cross", "multiplayer_overlays", "FM_Tat_M_024",
                "FM_Tat_F_024", 350),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "LS Bold", "multiplayer_overlays", "FM_Tat_M_025",
                "FM_Tat_F_025", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Trinity Knot", "multiplayer_overlays", "FM_Tat_M_029",
                "FM_Tat_F_029", 100),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Lucky Celtic Dogs", "multiplayer_overlays", "FM_Tat_M_030",
                "FM_Tat_F_030", 200),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Flaming Shamrock", "multiplayer_overlays", "FM_Tat_M_034",
                "FM_Tat_F_034", 150),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Way of the Gun", "multiplayer_overlays", "FM_Tat_M_036",
                "FM_Tat_F_036", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Stone Cross", "multiplayer_overlays", "FM_Tat_M_044",
                "FM_Tat_F_044", 250),
            new BusinessTattooModel(TATTOO_ZONE_TORSO, "Skulls and Rose", "multiplayer_overlays", "FM_Tat_M_045",
                "FM_Tat_F_045", 400),

            // Head
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Cash is King", "mpbusiness_overlays", "MP_Buis_M_Neck_000",
                string.Empty, 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Bold Dollar Sign", "mpbusiness_overlays", "MP_Buis_M_Neck_001",
                string.Empty, 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Script Dollar Sign", "mpbusiness_overlays", "MP_Buis_M_Neck_002",
                string.Empty, 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "$100", "mpbusiness_overlays", "MP_Buis_M_Neck_003", string.Empty,
                150),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Val-de-Grace Logo", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Neck_000", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Money Rose", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_Neck_001", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Los Muertos", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_007",
                "MP_Xmas2_F_Tat_007", 150),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Snake Head Outline", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_024", "MP_Xmas2_F_Tat_024", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Snake Head Color", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_025",
                "MP_Xmas2_F_Tat_025", 150),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Beautiful Death", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_029",
                "MP_Xmas2_F_Tat_029", 150),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Lock & Load", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_003_M", "MP_Gunrunning_Tattoo_003_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Beautiful Eye", "mphipster_overlays", "FM_Hip_M_Tat_005",
                "FM_Hip_F_Tat_005", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Geo Fox", "mphipster_overlays", "FM_Hip_M_Tat_021",
                "FM_Hip_F_Tat_021", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Morbid Arachnid", "mpbiker_overlays", "MP_MP_Biker_Tat_009_M",
                "MP_MP_Biker_Tat_009_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "FTW", "mpbiker_overlays", "MP_MP_Biker_Tat_038_M",
                "MP_MP_Biker_Tat_038_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Western Stylized", "mpbiker_overlays", "MP_MP_Biker_Tat_051_M",
                "MP_MP_Biker_Tat_051_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Sinner", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_011_M",
                "MP_Smuggler_Tattoo_011_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Thief", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_012_M",
                "MP_Smuggler_Tattoo_012_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Stunt Skull", "mpstunt_overlays", "MP_MP_Stunt_Tat_000_M",
                "MP_MP_Stunt_Tat_000_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Scorpion", "mpstunt_overlays", "MP_MP_Stunt_Tat_004_M",
                "MP_MP_Stunt_Tat_004_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Toxic Spider", "mpstunt_overlays", "MP_MP_Stunt_Tat_006_M",
                "MP_MP_Stunt_Tat_006_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Bat Wheel", "mpstunt_overlays", "MP_MP_Stunt_Tat_017_M",
                "MP_MP_Stunt_Tat_017_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Flaming Quad", "mpstunt_overlays", "MP_MP_Stunt_Tat_042_M",
                "MP_MP_Stunt_Tat_042_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_HEAD, "Skull", "multiplayer_overlays", "FM_Tat_Award_M_000",
                "FM_Tat_Award_F_000", 100),

            // Left arm
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "$100 Bill", "mpbusiness_overlays", "MP_Buis_M_LeftArm_000",
                string.Empty, 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "All-Seeing Eye", "mpbusiness_overlays",
                "MP_Buis_M_LeftArm_001", string.Empty, 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Greed is Good", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_LArm_000", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Skull Rider", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_000",
                "MP_Xmas2_F_Tat_000", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Electric Snake", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_010", "MP_Xmas2_F_Tat_010", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "8 Ball Skull", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_012",
                "MP_Xmas2_F_Tat_012", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Time's Up Outline", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_020", "MP_Xmas2_F_Tat_020", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Time's Up Color", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_021", "MP_Xmas2_F_Tat_021", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Sidearm", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_004_M", "MP_Gunrunning_Tattoo_004_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Bandolier", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_008_M", "MP_Gunrunning_Tattoo_008_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Spiked Skull", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_015_M", "MP_Gunrunning_Tattoo_015_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Blood Money", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_016_M", "MP_Gunrunning_Tattoo_016_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Praying Skull", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_025_M", "MP_Gunrunning_Tattoo_025_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Serpent Revolver", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_027_M", "MP_Gunrunning_Tattoo_027_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Diamond Sparkle", "mphipster_overlays", "FM_Hip_M_Tat_003",
                "FM_Hip_F_Tat_003", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Bricks", "mphipster_overlays", "FM_Hip_M_Tat_007",
                "FM_Hip_F_Tat_007", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Mustache", "mphipster_overlays", "FM_Hip_M_Tat_015",
                "FM_Hip_F_Tat_015", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Lightning Bolt", "mphipster_overlays", "FM_Hip_M_Tat_016",
                "FM_Hip_F_Tat_016", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Pizza", "mphipster_overlays", "FM_Hip_M_Tat_026",
                "FM_Hip_F_Tat_026", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Padlock", "mphipster_overlays", "FM_Hip_M_Tat_027",
                "FM_Hip_F_Tat_027", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Thorny Rose", "mphipster_overlays", "FM_Hip_M_Tat_028",
                "FM_Hip_F_Tat_028", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Stop", "mphipster_overlays", "FM_Hip_M_Tat_034",
                "FM_Hip_F_Tat_034", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Sunrise", "mphipster_overlays", "FM_Hip_M_Tat_037",
                "FM_Hip_F_Tat_037", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Sleeve", "mphipster_overlays", "FM_Hip_M_Tat_039",
                "FM_Hip_F_Tat_039", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Triangle White", "mphipster_overlays", "FM_Hip_M_Tat_043",
                "FM_Hip_F_Tat_043", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Peace", "mphipster_overlays", "FM_Hip_M_Tat_048",
                "FM_Hip_F_Tat_048", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Piston Sleeve", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_004_M", "MP_MP_ImportExport_Tat_004_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Scarlett", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_008_M", "MP_MP_ImportExport_Tat_008_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "No Evil", "mplowrider_overlays", "MP_LR_Tat_005_M",
                "MP_LR_Tat_005_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Los Santos Life", "mplowrider_overlays", "MP_LR_Tat_027_M",
                "MP_LR_Tat_027_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "City Sorrow", "mplowrider_overlays", "MP_LR_Tat_033_M",
                "MP_LR_Tat_033_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Toxic Trails", "mpairraces_overlays",
                "MP_Airraces_Tattoo_003_M", "MP_Airraces_Tattoo_003_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Urban Stunter", "mpbiker_overlays", "MP_MP_Biker_Tat_012_M",
                "MP_MP_Biker_Tat_012_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Macabre Tree", "mpbiker_overlays", "MP_MP_Biker_Tat_016_M",
                "MP_MP_Biker_Tat_016_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Cranial Rose", "mpbiker_overlays", "MP_MP_Biker_Tat_020_M",
                "MP_MP_Biker_Tat_020_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Live to Ride", "mpbiker_overlays", "MP_MP_Biker_Tat_024_M",
                "MP_MP_Biker_Tat_024_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Good Luck", "mpbiker_overlays", "MP_MP_Biker_Tat_025_M",
                "MP_MP_Biker_Tat_025_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Chain Fist", "mpbiker_overlays", "MP_MP_Biker_Tat_035_M",
                "MP_MP_Biker_Tat_035_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Ride Hard Die Fast", "mpbiker_overlays",
                "MP_MP_Biker_Tat_045_M", "MP_MP_Biker_Tat_045_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Muffler Helmet", "mpbiker_overlays", "MP_MP_Biker_Tat_053_M",
                "MP_MP_Biker_Tat_053_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Poison Scorpion", "mpbiker_overlays",
                "MP_MP_Biker_Tat_055_M", "MP_MP_Biker_Tat_055_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Love Hustle", "mplowrider2_overlays", "MP_LR_Tat_006_M",
                "MP_LR_Tat_006_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Skeleton Party", "mplowrider2_overlays", "MP_LR_Tat_018_M",
                "MP_LR_Tat_018_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "My Crazy Life", "mplowrider2_overlays", "MP_LR_Tat_022_M",
                "MP_LR_Tat_022_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Archangel & Mary", "mpluxe_overlays", "MP_LUXE_TAT_020_M",
                "MP_LUXE_TAT_020_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Gabriel", "mpluxe_overlays", "MP_LUXE_TAT_021_M",
                "MP_LUXE_TAT_021_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Fatal Dagger", "mpluxe2_overlays", "MP_LUXE_TAT_005_M",
                "MP_LUXE_TAT_005_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Egyptian Mural", "mpluxe2_overlays", "MP_LUXE_TAT_016_M",
                "MP_LUXE_TAT_016_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Divine Goddess", "mpluxe2_overlays", "MP_LUXE_TAT_018_M",
                "MP_LUXE_TAT_018_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Python Skull", "mpluxe2_overlays", "MP_LUXE_TAT_028_M",
                "MP_LUXE_TAT_028_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Geometric Design", "mpluxe2_overlays", "MP_LUXE_TAT_031_M",
                "MP_LUXE_TAT_031_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Honor", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_004_M",
                "MP_Smuggler_Tattoo_004_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Horrors Of The Deep", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_008_M", "MP_Smuggler_Tattoo_008_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Mermaid's Curse", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_014_M", "MP_Smuggler_Tattoo_014_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "8 Eyed Skull", "mpstunt_overlays", "MP_MP_Stunt_Tat_001_M",
                "MP_MP_Stunt_Tat_001_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Big Cat", "mpstunt_overlays", "MP_MP_Stunt_Tat_002_M",
                "MP_MP_Stunt_Tat_002_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Moonlight Ride", "mpstunt_overlays", "MP_MP_Stunt_Tat_008_M",
                "MP_MP_Stunt_Tat_008_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Piston Head", "mpstunt_overlays", "MP_MP_Stunt_Tat_022_M",
                "MP_MP_Stunt_Tat_022_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Tanked", "mpstunt_overlays", "MP_MP_Stunt_Tat_023_M",
                "MP_MP_Stunt_Tat_023_F", 450),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Stuntman's End", "mpstunt_overlays", "MP_MP_Stunt_Tat_035_M",
                "MP_MP_Stunt_Tat_035_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Kaboom", "mpstunt_overlays", "MP_MP_Stunt_Tat_039_M",
                "MP_MP_Stunt_Tat_039_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Engine Arm", "mpstunt_overlays", "MP_MP_Stunt_Tat_043_M",
                "MP_MP_Stunt_Tat_043_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Burning Heart", "multiplayer_overlays", "FM_Tat_Award_M_001",
                "FM_Tat_Award_F_001", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Racing Blonde", "multiplayer_overlays", "FM_Tat_Award_M_007",
                "FM_Tat_Award_F_007", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Racing Brunette", "multiplayer_overlays",
                "FM_Tat_Award_M_015", "FM_Tat_Award_F_015", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Serpents", "multiplayer_overlays", "FM_Tat_M_005",
                "FM_Tat_F_005", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Oriental Mural", "multiplayer_overlays", "FM_Tat_M_006",
                "FM_Tat_F_006", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Zodiac Skull", "multiplayer_overlays", "FM_Tat_M_015",
                "FM_Tat_F_015", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Lady M", "multiplayer_overlays", "FM_Tat_M_031",
                "FM_Tat_F_031", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_ARM, "Dope Skull", "multiplayer_overlays", "FM_Tat_M_041",
                "FM_Tat_F_041", 100),

            // Right arm
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Dollar Skull", "mpbusiness_overlays",
                "MP_Buis_M_RightArm_000", string.Empty, 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Green", "mpbusiness_overlays", "MP_Buis_M_RightArm_001",
                string.Empty, 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Dollar Sign", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_RArm_000", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Snake Outline", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_003", "MP_Xmas2_F_Tat_003", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Snake Shaded", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_004", "MP_Xmas2_F_Tat_004", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Death Before Dishonor", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_008", "MP_Xmas2_F_Tat_008", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "You're Next Outline", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_022", "MP_Xmas2_F_Tat_022", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "You're Next Color", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_023", "MP_Xmas2_F_Tat_023", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Fuck Luck Outline", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_026", "MP_Xmas2_F_Tat_026", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Fuck Luck Color", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_027", "MP_Xmas2_F_Tat_027", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Grenade", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_002_M", "MP_Gunrunning_Tattoo_002_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Have a Nice Day", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_021_M", "MP_Gunrunning_Tattoo_021_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Combat Reaper", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_024_M", "MP_Gunrunning_Tattoo_024_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Single Arrow", "mphipster_overlays", "FM_Hip_M_Tat_001",
                "FM_Hip_F_Tat_001", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Bone", "mphipster_overlays", "FM_Hip_M_Tat_004",
                "FM_Hip_F_Tat_004", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Cube", "mphipster_overlays", "FM_Hip_M_Tat_008",
                "FM_Hip_F_Tat_008", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Horseshoe", "mphipster_overlays", "FM_Hip_M_Tat_010",
                "FM_Hip_F_Tat_010", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Spray Can", "mphipster_overlays", "FM_Hip_M_Tat_014",
                "FM_Hip_F_Tat_014", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Eye Triangle", "mphipster_overlays", "FM_Hip_M_Tat_017",
                "FM_Hip_F_Tat_017", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Origami", "mphipster_overlays", "FM_Hip_M_Tat_018",
                "FM_Hip_F_Tat_018", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Geo Pattern", "mphipster_overlays", "FM_Hip_M_Tat_020",
                "FM_Hip_F_Tat_020", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Pencil", "mphipster_overlays", "FM_Hip_M_Tat_022",
                "FM_Hip_F_Tat_022", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Smiley", "mphipster_overlays", "FM_Hip_M_Tat_023",
                "FM_Hip_F_Tat_023", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Shapes", "mphipster_overlays", "FM_Hip_M_Tat_036",
                "FM_Hip_F_Tat_036", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Triangle Black", "mphipster_overlays", "FM_Hip_M_Tat_044",
                "FM_Hip_F_Tat_044", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Mesh Band", "mphipster_overlays", "FM_Hip_M_Tat_045",
                "FM_Hip_F_Tat_045", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Mechanical Sleeve", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_003_M", "MP_MP_ImportExport_Tat_003_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Dialed In", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_005_M", "MP_MP_ImportExport_Tat_005_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Engulfed Block", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_006_M", "MP_MP_ImportExport_Tat_006_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Drive Forever", "mpimportexport_overlays",
                "MP_MP_ImportExport_Tat_007_M", "MP_MP_ImportExport_Tat_007_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Seductress", "mplowrider_overlays", "MP_LR_Tat_015_M",
                "MP_LR_Tat_015_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Swooping Eagle", "mpbiker_overlays",
                "MP_MP_Biker_Tat_007_M", "MP_MP_Biker_Tat_007_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Lady Mortality", "mpbiker_overlays",
                "MP_MP_Biker_Tat_014_M", "MP_MP_Biker_Tat_014_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Eagle Emblem", "mpbiker_overlays", "MP_MP_Biker_Tat_033_M",
                "MP_MP_Biker_Tat_033_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Grim Rider", "mpbiker_overlays", "MP_MP_Biker_Tat_042_M",
                "MP_MP_Biker_Tat_042_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Skull Chain", "mpbiker_overlays", "MP_MP_Biker_Tat_046_M",
                "MP_MP_Biker_Tat_046_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Snake Bike", "mpbiker_overlays", "MP_MP_Biker_Tat_047_M",
                "MP_MP_Biker_Tat_047_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "These Colors Don't Run", "mpbiker_overlays",
                "MP_MP_Biker_Tat_049_M", "MP_MP_Biker_Tat_049_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Mum", "mpbiker_overlays", "MP_MP_Biker_Tat_054_M",
                "MP_MP_Biker_Tat_054_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Lady Vamp", "mplowrider2_overlays", "MP_LR_Tat_003_M",
                "MP_LR_Tat_003_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Loving Los Muertos", "mplowrider2_overlays",
                "MP_LR_Tat_028_M", "MP_LR_Tat_028_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Black Tears", "mplowrider2_overlays", "MP_LR_Tat_035_M",
                "MP_LR_Tat_035_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Floral Raven", "mpluxe_overlays", "MP_LUXE_TAT_004_M",
                "MP_LUXE_TAT_004_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Mermaid Harpist", "mpluxe_overlays", "MP_LUXE_TAT_013_M",
                "MP_LUXE_TAT_013_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Geisha Bloom", "mpluxe_overlays", "MP_LUXE_TAT_019_M",
                "MP_LUXE_TAT_019_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Intrometric", "mpluxe2_overlays", "MP_LUXE_TAT_010_M",
                "MP_LUXE_TAT_010_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Heavenly Deity", "mpluxe2_overlays", "MP_LUXE_TAT_017_M",
                "MP_LUXE_TAT_017_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Floral Print", "mpluxe2_overlays", "MP_LUXE_TAT_026_M",
                "MP_LUXE_TAT_026_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Geometric Design", "mpluxe2_overlays", "MP_LUXE_TAT_030_M",
                "MP_LUXE_TAT_030_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Crackshot", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_001_M", "MP_Smuggler_Tattoo_001_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Mutiny", "mpsmuggler_overlays", "MP_Smuggler_Tattoo_005_M",
                "MP_Smuggler_Tattoo_005_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Stylized Kraken", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_023_M", "MP_Smuggler_Tattoo_023_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Poison Wrench", "mpstunt_overlays", "MP_MP_Stunt_Tat_003_M",
                "MP_MP_Stunt_Tat_003_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Arachnid of Death", "mpstunt_overlays",
                "MP_MP_Stunt_Tat_009_M", "MP_MP_Stunt_Tat_009_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Grave Vulture", "mpstunt_overlays", "MP_MP_Stunt_Tat_010_M",
                "MP_MP_Stunt_Tat_010_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Coffin Racer", "mpstunt_overlays", "MP_MP_Stunt_Tat_016_M",
                "MP_MP_Stunt_Tat_016_F", 350),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Biker Stallion", "mpstunt_overlays",
                "MP_MP_Stunt_Tat_036_M", "MP_MP_Stunt_Tat_036_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "One Down Five Up", "mpstunt_overlays",
                "MP_MP_Stunt_Tat_038_M", "MP_MP_Stunt_Tat_038_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Seductive Mechanic", "mpstunt_overlays",
                "MP_MP_Stunt_Tat_049_M", "MP_MP_Stunt_Tat_049_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Grim Reaper Smoking Gun", "multiplayer_overlays",
                "FM_Tat_Award_M_002", "FM_Tat_Award_F_002", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Ride or Die", "multiplayer_overlays", "FM_Tat_Award_M_010",
                "FM_Tat_Award_F_010", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Brotherhood", "multiplayer_overlays", "FM_Tat_M_000",
                "FM_Tat_F_000", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Dragons", "multiplayer_overlays", "FM_Tat_M_001",
                "FM_Tat_F_001", 350),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Dragons and Skull", "multiplayer_overlays", "FM_Tat_M_003",
                "FM_Tat_F_003", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Flower Mural", "multiplayer_overlays", "FM_Tat_M_014",
                "FM_Tat_F_014", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Serpent Skull", "multiplayer_overlays", "FM_Tat_M_018",
                "FM_Tat_F_018", 350),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Virgin Mary", "multiplayer_overlays", "FM_Tat_M_027",
                "FM_Tat_F_027", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Mermaid", "multiplayer_overlays", "FM_Tat_M_028",
                "FM_Tat_F_028", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Dagger", "multiplayer_overlays", "FM_Tat_M_038",
                "FM_Tat_F_038", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_ARM, "Lion", "multiplayer_overlays", "FM_Tat_M_047",
                "FM_Tat_F_047", 100),

            // Left leg
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Single", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_LLeg_000", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Spider Outline", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_001", "MP_Xmas2_F_Tat_001", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Spider Color", "mpchristmas2_overlays", "MP_Xmas2_M_Tat_002",
                "MP_Xmas2_F_Tat_002", 350),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Patriot Skull", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_005_M", "MP_Gunrunning_Tattoo_005_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Stylized Tiger", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_007_M", "MP_Gunrunning_Tattoo_007_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Death Skull", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_011_M", "MP_Gunrunning_Tattoo_011_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Rose Revolver", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_023_M", "MP_Gunrunning_Tattoo_023_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Squares", "mphipster_overlays", "FM_Hip_M_Tat_009",
                "FM_Hip_F_Tat_009", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Charm", "mphipster_overlays", "FM_Hip_M_Tat_019",
                "FM_Hip_F_Tat_019", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Black Anchor", "mphipster_overlays", "FM_Hip_M_Tat_040",
                "FM_Hip_F_Tat_040", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "LS Serpent", "mplowrider_overlays", "MP_LR_Tat_007_M",
                "MP_LR_Tat_007_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Presidents", "mplowrider_overlays", "MP_LR_Tat_020_M",
                "MP_LR_Tat_020_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Rose Tribute", "mpbiker_overlays", "MP_MP_Biker_Tat_002_M",
                "MP_MP_Biker_Tat_002_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Ride or Die", "mpbiker_overlays", "MP_MP_Biker_Tat_015_M",
                "MP_MP_Biker_Tat_015_F", 100),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Bad Luck", "mpbiker_overlays", "MP_MP_Biker_Tat_027_M",
                "MP_MP_Biker_Tat_027_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Engulfed Skull", "mpbiker_overlays", "MP_MP_Biker_Tat_036_M",
                "MP_MP_Biker_Tat_036_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Scorched Soul", "mpbiker_overlays", "MP_MP_Biker_Tat_037_M",
                "MP_MP_Biker_Tat_037_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Ride Free", "mpbiker_overlays", "MP_MP_Biker_Tat_044_M",
                "MP_MP_Biker_Tat_044_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Bone Cruiser", "mpbiker_overlays", "MP_MP_Biker_Tat_056_M",
                "MP_MP_Biker_Tat_056_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Laughing Skull", "mpbiker_overlays", "MP_MP_Biker_Tat_057_M",
                "MP_MP_Biker_Tat_057_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Death Us Do Part", "mplowrider2_overlays", "MP_LR_Tat_029_M",
                "MP_LR_Tat_029_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Serpent of Death", "mpluxe_overlays", "MP_LUXE_TAT_000_M",
                "MP_LUXE_TAT_000_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Cross of Roses", "mpluxe2_overlays", "MP_LUXE_TAT_011_M",
                "MP_LUXE_TAT_011_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Dagger Devil", "mpstunt_overlays", "MP_MP_Stunt_Tat_007_M",
                "MP_MP_Stunt_Tat_007_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Dirt Track Hero", "mpstunt_overlays",
                "MP_MP_Stunt_Tat_013_M", "MP_MP_Stunt_Tat_013_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Golden Cobra", "mpstunt_overlays", "MP_MP_Stunt_Tat_021_M",
                "MP_MP_Stunt_Tat_021_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Quad Goblin", "mpstunt_overlays", "MP_MP_Stunt_Tat_028_M",
                "MP_MP_Stunt_Tat_028_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Stunt Jesus", "mpstunt_overlays", "MP_MP_Stunt_Tat_031_M",
                "MP_MP_Stunt_Tat_031_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Dragon and Dagger", "multiplayer_overlays",
                "FM_Tat_Award_M_009", "FM_Tat_Award_F_009", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Melting Skull", "multiplayer_overlays", "FM_Tat_M_002",
                "FM_Tat_F_002", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Dragon Mural", "multiplayer_overlays", "FM_Tat_M_008",
                "FM_Tat_F_008", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Serpent Skull", "multiplayer_overlays", "FM_Tat_M_021",
                "FM_Tat_F_021", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Hottie", "multiplayer_overlays", "FM_Tat_M_023",
                "FM_Tat_F_023", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Smoking Dagger", "multiplayer_overlays", "FM_Tat_M_026",
                "FM_Tat_F_026", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Faith", "multiplayer_overlays", "FM_Tat_M_032",
                "FM_Tat_F_032", 200),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Chinese Dragon", "multiplayer_overlays", "FM_Tat_M_033",
                "FM_Tat_F_033", 300),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Dragon", "multiplayer_overlays", "FM_Tat_M_035",
                "FM_Tat_F_035", 250),
            new BusinessTattooModel(TATTOO_ZONE_LEFT_LEG, "Grim Reaper", "multiplayer_overlays", "FM_Tat_M_037",
                "FM_Tat_F_037", 200),

            // Right leg
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Diamond Crown", "mpbusiness_overlays", string.Empty,
                "MP_Buis_F_RLeg_000", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Floral Dagger", "mpchristmas2_overlays",
                "MP_Xmas2_M_Tat_014", "MP_Xmas2_F_Tat_014", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Combat Skull", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_006_M", "MP_Gunrunning_Tattoo_006_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Restless Skull", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_026_M", "MP_Gunrunning_Tattoo_026_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Pistol Ace", "mpgunrunning_overlays",
                "MP_Gunrunning_Tattoo_030_M", "MP_Gunrunning_Tattoo_030_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Grub", "mphipster_overlays", "FM_Hip_M_Tat_038",
                "FM_Hip_F_Tat_038", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Sparkplug", "mphipster_overlays", "FM_Hip_M_Tat_042",
                "FM_Hip_F_Tat_042", 100),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Ink Me", "mplowrider_overlays", "MP_LR_Tat_017_M",
                "MP_LR_Tat_017_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Dance of Hearts", "mplowrider_overlays", "MP_LR_Tat_023_M",
                "MP_LR_Tat_023_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Dragon's Fury", "mpbiker_overlays", "MP_MP_Biker_Tat_004_M",
                "MP_MP_Biker_Tat_004_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Western Insignia", "mpbiker_overlays",
                "MP_MP_Biker_Tat_022_M", "MP_MP_Biker_Tat_022_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Dusk Rider", "mpbiker_overlays", "MP_MP_Biker_Tat_028_M",
                "MP_MP_Biker_Tat_028_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "American Made", "mpbiker_overlays", "MP_MP_Biker_Tat_040_M",
                "MP_MP_Biker_Tat_040_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "STFU", "mpbiker_overlays", "MP_MP_Biker_Tat_048_M",
                "MP_MP_Biker_Tat_048_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "San Andreas Prayer", "mplowrider2_overlays",
                "MP_LR_Tat_030_M", "MP_LR_Tat_030_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Elaborate Los Muertos", "mpluxe_overlays",
                "MP_LUXE_TAT_001_M", "MP_LUXE_TAT_001_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Starmetric", "mpluxe2_overlays", "MP_LUXE_TAT_023_M",
                "MP_LUXE_TAT_023_F", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Homeward Bound", "mpsmuggler_overlays",
                "MP_Smuggler_Tattoo_020_M", "MP_Smuggler_Tattoo_020_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Demon Spark Plug", "mpstunt_overlays",
                "MP_MP_Stunt_Tat_005_M", "MP_MP_Stunt_Tat_005_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Praying Gloves", "mpstunt_overlays",
                "MP_MP_Stunt_Tat_015_M", "MP_MP_Stunt_Tat_015_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Piston Angel", "mpstunt_overlays", "MP_MP_Stunt_Tat_020_M",
                "MP_MP_Stunt_Tat_020_F", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Speed Freak", "mpstunt_overlays", "MP_MP_Stunt_Tat_025_M",
                "MP_MP_Stunt_Tat_025_F", 150),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Wheelie Mouse", "mpstunt_overlays", "MP_MP_Stunt_Tat_032_M",
                "MP_MP_Stunt_Tat_032_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Severed Hand", "mpstunt_overlays", "MP_MP_Stunt_Tat_045_M",
                "MP_MP_Stunt_Tat_045_F", 400),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Brake Knife", "mpstunt_overlays", "MP_MP_Stunt_Tat_047_M",
                "MP_MP_Stunt_Tat_047_F", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Skull and Sword", "multiplayer_overlays",
                "FM_Tat_Award_M_006", "FM_Tat_Award_F_006", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "The Warrior", "multiplayer_overlays", "FM_Tat_M_007",
                "FM_Tat_F_007", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Tribal", "multiplayer_overlays", "FM_Tat_M_017",
                "FM_Tat_F_017", 250),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Fiery Dragon", "multiplayer_overlays", "FM_Tat_M_022",
                "FM_Tat_F_022", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Broken Skull", "multiplayer_overlays", "FM_Tat_M_039",
                "FM_Tat_F_039", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Flaming Skull", "multiplayer_overlays", "FM_Tat_M_040",
                "FM_Tat_F_040", 300),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Flaming Scorpion", "multiplayer_overlays", "FM_Tat_M_042",
                "FM_Tat_F_042", 200),
            new BusinessTattooModel(TATTOO_ZONE_RIGHT_LEG, "Indian Ram", "multiplayer_overlays", "FM_Tat_M_043",
                "FM_Tat_F_043", 200)
        };
        ...
        public static List<JobPickModel> JOB_PICK_LIST = new List<JobPickModel> {
            new JobPickModel(JOB_FASTFOOD, 501, GenRes.fastfood_job, new Vector3(-133.24f, 6377.585f, 32.17684f),
                DescRes.job_fastfood),
            new JobPickModel(JOB_HOOKER, 121, GenRes.hooker, new Vector3(136.58f, -1278.55f, 29.45f),
                DescRes.job_hooker),
            new JobPickModel(JOB_GARBAGE, 318, GenRes.garbage_job, new Vector3(-322.088f, -1546.014f, 31.01991f),
                DescRes.job_garbage),
            new JobPickModel(JOB_MECHANIC, 72, GenRes.mechanic_job, new Vector3(119.923f, 6627.261f, 31.94834f),
                DescRes.job_mechanic),
            new JobPickModel(JOB_MECHANIC, 72, GenRes.mechanic_job, new Vector3(1187.899f, 2646.012f, 38.36409f),
                DescRes.job_mechanic),
            new JobPickModel(JOB_THIEF, 0, GenRes.thief_job, new Vector3(1529.182f, 3794.486f, 34.46811f),
                DescRes.job_thief),
            new JobPickModel(JOB_TRUCKER, 0, GenRes.trucker_job, new Vector3(1197.0f, -3253.58f, 7.09519f),
                DescRes.job_trucker)
        };
        ...
        public static Dictionary<WeaponHash, string> WEAPON_ITEM_MODELS = new Dictionary<WeaponHash, string> {
            {WeaponHash.AdvancedRifle, "w_ar_advancedrifle"}, {WeaponHash.APPistol, "w_pi_appistol"},
            {WeaponHash.AssaultRifle, "w_ar_assaultrifle"},
            {WeaponHash.AssaultShotgun, "w_sg_assaultshotgun"}, {WeaponHash.AssaultSMG, "w_sb_assaultsmg"},
            {WeaponHash.Ball, "w_am_baseball"},
            {WeaponHash.Bat, "w_me_bat"}, {WeaponHash.BattleAxe, "w_me_battleaxe"}, {WeaponHash.Bottle, "w_me_bottle"},
            {WeaponHash.BullpupRifle, "w_ar_bullpuprifle"},
            {WeaponHash.BullpupShotgun, "w_sg_bullpupshotgun"}, {WeaponHash.BZGas, "w_ex_bzgas"},
            {WeaponHash.CarbineRifle, "w_ar_carbinerifle"},
            {WeaponHash.CombatMG, "w_mg_combatmg"}, {WeaponHash.CombatPDW, "w_mg_combatpdw"},
            {WeaponHash.CombatPistol, "w_pi_combatpistol"},
            {WeaponHash.CompactGrenadeLauncher, "w_lr_compactgrenadelauncher"},
            {WeaponHash.CompactRifle, "w_ar_compactrifle"}, {WeaponHash.Crowbar, "w_me_crowbar"},
            {WeaponHash.Dagger, "w_me_dagger"}, {WeaponHash.DoubleBarrelShotgun, "w_sg_doublebarrelshotgun"},
            {WeaponHash.FireExtinguisher, "w_am_fireextinguisher"},
            {WeaponHash.Firework, "w_lr_firework"}, {WeaponHash.Flare, "w_am_flare"},
            {WeaponHash.FlareGun, "w_pi_flaregun"}, {WeaponHash.Flashlight, "w_me_flashlight"},
            {WeaponHash.GolfClub, "w_me_golfclub"}, {WeaponHash.Grenade, "w_ex_grenade"},
            {WeaponHash.GrenadeLauncher, "w_lr_grenadelauncher"},
            {WeaponHash.GrenadeLauncherSmoke, "w_lr_grenadelaunchersmoke"}, {WeaponHash.Gusenberg, "w_sb_gusenberg"},
            {WeaponHash.Hammer, "w_me_hammer"},
            {WeaponHash.Hatchet, "w_me_hatchet"}, {WeaponHash.HeavyPistol, "w_pi_heavypistol"},
            {WeaponHash.HeavyShotgun, "w_sg_heavyshotgun"},
            {WeaponHash.HeavySniper, "w_sr_heavysniper"}, {WeaponHash.HomingLauncher, "w_lr_hominglauncher"},
            {WeaponHash.Knife, "w_me_knife"},
            {WeaponHash.KnuckleDuster, "w_me_knuckleduster"}, {WeaponHash.Machete, "w_me_machete"},
            {WeaponHash.MachinePistol, "w_pi_machinepistol"},
            {WeaponHash.MarksmanPistol, "w_pi_marksmanpistol"}, {WeaponHash.MarksmanRifle, "w_sr_marksmanrifle"},
            {WeaponHash.MG, "w_mg_mg"}, {WeaponHash.MicroSMG, "w_sb_microsmg"},
            {WeaponHash.Minigun, "w_mg_minigun"}, {WeaponHash.MiniSMG, "w_sb_minismg"},
            {WeaponHash.Molotov, "w_ex_molotov"}, {WeaponHash.Musket, "w_ar_musket"},
            {WeaponHash.Nightstick, "w_me_nightstick"}, {WeaponHash.NightVision, "w_am_nightvision"},
            {WeaponHash.Parachute, "w_am_parachute"}, {WeaponHash.PetrolCan, "w_am_petrolcan"},
            {WeaponHash.PipeBomb, "w_ex_pipebomb"}, {WeaponHash.Pistol, "w_pi_pistol"},
            {WeaponHash.Pistol50, "w_pi_pistol50"}, {WeaponHash.PoolCue, "w_me_poolcue"},
            {WeaponHash.ProximityMine, "w_ex_proximitymine"}, {WeaponHash.PumpShotgun, "w_sg_pumpshotgun"},
            {WeaponHash.Railgun, "w_ar_railgun"}, {WeaponHash.Revolver, "w_pi_revolver"},
            {WeaponHash.RPG, "w_lr_rpg"}, {WeaponHash.SawnOffShotgun, "w_sg_sawnoffshotgun"},
            {WeaponHash.SMG, "w_sb_smg"}, {WeaponHash.SmokeGrenade, "w_ex_smokegrenade"},
            {WeaponHash.SniperRifle, "w_sr_sniperrifle"}, {WeaponHash.Snowball, "w_am_snowball"},
            {WeaponHash.SNSPistol, "w_pi_snspistol"},
            {WeaponHash.SpecialCarbine, "w_ar_specialcarbine"}, {WeaponHash.StickyBomb, "w_ex_stickybomb"},
            {WeaponHash.StunGun, "w_pi_stungun"},
            {WeaponHash.SweeperShotgun, "w_sg_sweepershotgun"}, {WeaponHash.SwitchBlade, "w_me_switchblade"},
            {WeaponHash.VintagePistol, "w_pi_vintagepistol"}, {WeaponHash.Wrench, "w_me_wrench"}
        };
    }
}