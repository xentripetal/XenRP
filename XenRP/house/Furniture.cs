                ...
                if (house != null && house.owner == player.Name)
                    switch (action.ToLower()) {
                        case Commands.ARG_PLACE:
                            ...
                            furniture.handle = NAPI.Object.CreateObject(furniture.hash, furniture.position,
                                furniture.rotation, (byte) furniture.house);
                        }

                            furnitureList.Add(furniture);
                            break;
                        case Commands.ARG_MOVE:
                            var furnitureJson = NAPI.Util.ToJson(GetFurnitureInHouse(houseId));
