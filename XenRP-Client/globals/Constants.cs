...
namespace XenRP.Client.globals {
    internal class Constants {
        ...
        public static readonly List<ClothesModel> CLOTHES_TYPES = new List<ClothesModel> {
            new ClothesModel(0, 1, "clothes.masks"), new ClothesModel(0, 3, "clothes.torso"),
            new ClothesModel(0, 4, "clothes.legs"),
            new ClothesModel(0, 5, "clothes.bags"), new ClothesModel(0, 6, "clothes.feet"),
            new ClothesModel(0, 7, "clothes.complements"),
            new ClothesModel(0, 8, "clothes.undershirt"), new ClothesModel(0, 11, "clothes.tops"),
            new ClothesModel(1, 0, "clothes.hats"),
            new ClothesModel(1, 1, "clothes.glasses"), new ClothesModel(1, 2, "clothes.earrings"),
            new ClothesModel(1, 6, "clothes.watches"),
        ...
        public static readonly List<FaceOption> MALE_FACE_OPTIONS = new List<FaceOption> {
            new FaceOption("hairdresser.hair", 0, 36), new FaceOption("hairdresser.hair-primary", 0, 63),
            new FaceOption("hairdresser.hair-secondary", 0, 63),
            new FaceOption("hairdresser.eyebrows", 0, 33), new FaceOption("hairdresser.eyebrows-color", 0, 63),
            new FaceOption("hairdresser.beard", -1, 36),
        ...
        public static readonly List<FaceOption> FEMALE_FACE_OPTIONS = new List<FaceOption> {
            new FaceOption("hairdresser.hair", 0, 38), new FaceOption("hairdresser.hair-primary", 0, 63),
            new FaceOption("hairdresser.hair-secondary", 0, 63),
            new FaceOption("hairdresser.eyebrows", 0, 33), new FaceOption("hairdresser.eyebrows-color", 0, 63)
        };
        ...
        public static readonly List<CarPiece> CAR_PIECE_LIST = new List<CarPiece> {
            new CarPiece(0, "mechanic.spoiler", 250), new CarPiece(1, "mechanic.front-bumper", 250),
            new CarPiece(2, "mechanic.rear-bumper", 250),
            new CarPiece(3, "mechanic.side-skirt", 250), new CarPiece(4, "mechanic.exhaust", 100),
            new CarPiece(5, "mechanic.frame", 500),
            new CarPiece(6, "mechanic.grille", 200), new CarPiece(7, "mechanic.hood", 300),
            new CarPiece(8, "mechanic.fender", 100),
            new CarPiece(9, "mechanic.right-fender", 100), new CarPiece(10, "mechanic.roof", 400),
            new CarPiece(14, "mechanic.horn", 100),
            new CarPiece(15, "mechanic.suspension", 900), new CarPiece(22, "mechanic.xenon", 150),
            new CarPiece(23, "mechanic.front-wheels", 100),
            new CarPiece(24, "mechanic.back-wheels", 100), new CarPiece(25, "mechanic.plaque", 100),
            new CarPiece(27, "mechanic.trim-design", 800),
            new CarPiece(28, "mechanic.ornaments", 150), new CarPiece(33, "mechanic.steering-wheel", 100),
            new CarPiece(34, "mechanic.shift-lever", 100),
        ...
        public static List<string> VALID_WEAPONS = new List<string> {
            "weapon_pistol", "weapon_combatpistol", "weapon_pistol50", "weapon_snspistol", "weapon_heavypistol",
            "weapon_vintagepistol", "weapon_marksmanpistol",
            "weapon_revolver", "weapon_appistol", "weapon_flaregun", "weapon_microsmg", "weapon_machinepistol",
            "weapon_smg", "weapon_combatpdw", "weapon_mg",
            "weapon_combatmg", "weapon_gusenberg", "weapon_minismg", "weapon_assaultrifle", "weapon_carbinerifle",
            "weapon_advancedrifle", "weapon_specialcarbine",
            "weapon_bullpuprifle", "weapon_compactrifle", "weapon_sniperrifle", "weapon_heavysniper",
            "weapon_marksmanrifle", "weapon_pumpshotgun", "weapon_sawnoffshotgun",
