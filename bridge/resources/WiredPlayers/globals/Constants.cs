...
namespace WiredPlayers.globals
{
    public class Constants
    {
        ...
        {
            // Masks
            new BusinessClothesModel(0, "Cerdo", CLOTHES_MASK, 1, SEX_NONE, 250),
            new BusinessClothesModel(0, "Calavera", CLOTHES_MASK, 2, SEX_NONE, 250),
            new BusinessClothesModel(0, "Mono fumador", CLOTHES_MASK, 3, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hockey", CLOTHES_MASK, 4, SEX_NONE, 250),
            new BusinessClothesModel(0, "Mono feliz", CLOTHES_MASK, 5, SEX_NONE, 250),
            new BusinessClothesModel(0, "Cosa siniestra", CLOTHES_MASK, 6, SEX_NONE, 250),
            new BusinessClothesModel(0, "Gárgola", CLOTHES_MASK, 7, SEX_NONE, 250),
            new BusinessClothesModel(0, "Santa", CLOTHES_MASK, 8, SEX_NONE, 250),
            new BusinessClothesModel(0, "Reno", CLOTHES_MASK, 9, SEX_NONE, 250),
            new BusinessClothesModel(0, "Frosty", CLOTHES_MASK, 10, SEX_NONE, 250),
            new BusinessClothesModel(0, "Antifaz", CLOTHES_MASK, 11, SEX_NONE, 250),
            new BusinessClothesModel(0, "Pinocho veneciano", CLOTHES_MASK, 12, SEX_NONE, 250),
            new BusinessClothesModel(0, "Cupido", CLOTHES_MASK, 13, SEX_NONE, 250),
            new BusinessClothesModel(0, "Balística", CLOTHES_MASK, 14, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hockey calavera", CLOTHES_MASK, 15, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hannibal Lecter", CLOTHES_MASK, 16, SEX_NONE, 250),
            new BusinessClothesModel(0, "Gato", CLOTHES_MASK, 17, SEX_NONE, 250),
            new BusinessClothesModel(0, "Zorro", CLOTHES_MASK, 18, SEX_NONE, 250),
            new BusinessClothesModel(0, "Búho", CLOTHES_MASK, 19, SEX_NONE, 250),
            new BusinessClothesModel(0, "Tejón", CLOTHES_MASK, 20, SEX_NONE, 250),
            new BusinessClothesModel(0, "Oso", CLOTHES_MASK, 21, SEX_NONE, 250),
            new BusinessClothesModel(0, "Bisonte", CLOTHES_MASK, 22, SEX_NONE, 250),
            new BusinessClothesModel(0, "Toro", CLOTHES_MASK, 23, SEX_NONE, 250),
            new BusinessClothesModel(0, "Águila", CLOTHES_MASK, 24, SEX_NONE, 250),
            new BusinessClothesModel(0, "Grulla turbia", CLOTHES_MASK, 25, SEX_NONE, 250),
            new BusinessClothesModel(0, "Lobo", CLOTHES_MASK, 26, SEX_NONE, 250),
            new BusinessClothesModel(0, "Gorro de aviador", CLOTHES_MASK, 27, SEX_NONE, 250),
            new BusinessClothesModel(0, "Calavera negra", CLOTHES_MASK, 29, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hockey Jason", CLOTHES_MASK, 30, SEX_NONE, 250),
            new BusinessClothesModel(0, "Pingüino", CLOTHES_MASK, 31, SEX_NONE, 250),
            new BusinessClothesModel(0, "Media roja", CLOTHES_MASK, 32, SEX_NONE, 250),
            new BusinessClothesModel(0, "Jengibre feliz", CLOTHES_MASK, 33, SEX_NONE, 250),
            new BusinessClothesModel(0, "Duende", CLOTHES_MASK, 34, SEX_NONE, 250),
            new BusinessClothesModel(0, "Pasamontañas", CLOTHES_MASK, 35, SEX_NONE, 250),
            new BusinessClothesModel(0, "Media negra", CLOTHES_MASK, 37, SEX_NONE, 250),
            new BusinessClothesModel(0, "Zombie", CLOTHES_MASK, 39, SEX_NONE, 250),
            new BusinessClothesModel(0, "Momia", CLOTHES_MASK, 40, SEX_NONE, 250),
            new BusinessClothesModel(0, "Vampiro", CLOTHES_MASK, 41, SEX_NONE, 250),
            new BusinessClothesModel(0, "Reconstruído", CLOTHES_MASK, 42, SEX_NONE, 250),
            new BusinessClothesModel(0, "Superhéroe", CLOTHES_MASK, 43, SEX_NONE, 250),
            new BusinessClothesModel(0, "Waifu", CLOTHES_MASK, 44, SEX_NONE, 250),
            new BusinessClothesModel(0, "Detective", CLOTHES_MASK, 45, SEX_NONE, 250),
            new BusinessClothesModel(0, "Cinta policial", CLOTHES_MASK, 47, SEX_NONE, 250),
            new BusinessClothesModel(0, "Cinta", CLOTHES_MASK, 48, SEX_NONE, 250),
            new BusinessClothesModel(0, "Bolsa", CLOTHES_MASK, 49, SEX_NONE, 250),
            new BusinessClothesModel(0, "Estatua", CLOTHES_MASK, 50, SEX_NONE, 250),
            new BusinessClothesModel(0, "Bandana", CLOTHES_MASK, 51, SEX_NONE, 250),
            new BusinessClothesModel(0, "Capucha", CLOTHES_MASK, 53, SEX_NONE, 250),
            new BusinessClothesModel(0, "Camiseta", CLOTHES_MASK, 54, SEX_NONE, 250),
            new BusinessClothesModel(0, "Gorro", CLOTHES_MASK, 55, SEX_NONE, 250),
            new BusinessClothesModel(0, "Pasamontañas azul", CLOTHES_MASK, 56, SEX_NONE, 250),
            new BusinessClothesModel(0, "Pasamontañas lana", CLOTHES_MASK, 57, SEX_NONE, 250),
            new BusinessClothesModel(0, "Pasamontañas rallado", CLOTHES_MASK, 58, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hombre lobo", CLOTHES_MASK, 59, SEX_NONE, 250),
            new BusinessClothesModel(0, "Calabaza maligna", CLOTHES_MASK, 60, SEX_NONE, 250),
            new BusinessClothesModel(0, "Viejo zombie", CLOTHES_MASK, 61, SEX_NONE, 250),
            new BusinessClothesModel(0, "Freddy Krueger", CLOTHES_MASK, 62, SEX_NONE, 250),
            new BusinessClothesModel(0, "Shingeki no kyojin", CLOTHES_MASK, 63, SEX_NONE, 250),
            new BusinessClothesModel(0, "Calavera vomitada", CLOTHES_MASK, 64, SEX_NONE, 250),
            new BusinessClothesModel(0, "Perro lobo cabreado", CLOTHES_MASK, 65, SEX_NONE, 250),
            new BusinessClothesModel(0, "Moscardon con lengua", CLOTHES_MASK, 66, SEX_NONE, 250),
            new BusinessClothesModel(0, "Orco de mordor", CLOTHES_MASK, 67, SEX_NONE, 250),
            new BusinessClothesModel(0, "Demonio con cuernos", CLOTHES_MASK, 68, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hombre del saco", CLOTHES_MASK, 69, SEX_NONE, 250),
            new BusinessClothesModel(0, "Calavera mexicana zombie", CLOTHES_MASK, 70, SEX_NONE, 250),
            new BusinessClothesModel(0, "Bruja piruja", CLOTHES_MASK, 71, SEX_NONE, 250),
            new BusinessClothesModel(0, "Demonio con cuernos bronceado", CLOTHES_MASK, 72, SEX_NONE, 250),
            new BusinessClothesModel(0, "Sin pelo", CLOTHES_MASK, 73, SEX_NONE, 250),
            new BusinessClothesModel(0, "Jengibre enfadado bronceado", CLOTHES_MASK, 74, SEX_NONE, 250),
            new BusinessClothesModel(0, "Jengibre enfadado", CLOTHES_MASK, 75, SEX_NONE, 250),
            new BusinessClothesModel(0, "Papa noel grumete", CLOTHES_MASK, 76, SEX_NONE, 250),
            new BusinessClothesModel(0, "Arbol de navidad cutre", CLOTHES_MASK, 77, SEX_NONE, 250),
            new BusinessClothesModel(0, "Bizcocho de chocolate con crema pastelera", CLOTHES_MASK, 78, SEX_NONE, 250),
            new BusinessClothesModel(0, "Otro hombre lobo muy peludo", CLOTHES_MASK, 79, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hombre lobo con gorra LS", CLOTHES_MASK, 80, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hombre lobo listo para jugar al tenis", CLOTHES_MASK, 81, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hombre lobo gym", CLOTHES_MASK, 82, SEX_NONE, 250),
            new BusinessClothesModel(0, "Hombre lobo os desea feliz navidad", CLOTHES_MASK, 83, SEX_NONE, 250),
            new BusinessClothesModel(0, "Yeti de las nieves aburrido", CLOTHES_MASK, 84, SEX_NONE, 250),
            new BusinessClothesModel(0, "Pollo relleno de cara", CLOTHES_MASK, 85, SEX_NONE, 250),
            new BusinessClothesModel(0, "Vieja muy muy pasada de todo", CLOTHES_MASK, 86, SEX_NONE, 250),
            new BusinessClothesModel(0, "Abuelo con mala leche", CLOTHES_MASK, 87, SEX_NONE, 250),
            new BusinessClothesModel(0, "Vieja despues de proyecto hombre", CLOTHES_MASK, 88, SEX_NONE, 250),
            new BusinessClothesModel(0, "Tipo motorista negra", CLOTHES_MASK, 89, SEX_NONE, 250),
            new BusinessClothesModel(0, "Media cara nariz boca roja", CLOTHES_MASK, 90, SEX_NONE, 250),
            new BusinessClothesModel(0, "Casco del espacio", CLOTHES_MASK, 91, SEX_NONE, 250),
            new BusinessClothesModel(0, "Cthulhu adolescente", CLOTHES_MASK, 92, SEX_NONE, 250),
            new BusinessClothesModel(0, "T-REX", CLOTHES_MASK, 93, SEX_NONE, 250),
            new BusinessClothesModel(0, "Oni, demonio japones", CLOTHES_MASK, 94, SEX_NONE, 250),
            new BusinessClothesModel(0, "Payaso sin gracia", CLOTHES_MASK, 95, SEX_NONE, 250),
            new BusinessClothesModel(0, "King Kong", CLOTHES_MASK, 96, SEX_NONE, 250),
            new BusinessClothesModel(0, "Caballo", CLOTHES_MASK, 97, SEX_NONE, 250),
            new BusinessClothesModel(0, "Unicornio", CLOTHES_MASK, 98, SEX_NONE, 250),
            new BusinessClothesModel(0, "Calavera roja con trazos dorados", CLOTHES_MASK, 99, SEX_NONE, 250),
            new BusinessClothesModel(0, "PUG", CLOTHES_MASK, 100, SEX_NONE, 250),
            new BusinessClothesModel(0, "BIGNESS media cara nariz boca", CLOTHES_MASK, 101, SEX_NONE, 250),
            new BusinessClothesModel(0, "Dibujado por niños", CLOTHES_MASK, 102, SEX_NONE, 250),

            // Female pants
            new BusinessClothesModel(0, "vaqueros estrechos oscuros", CLOTHES_LEGS, 0, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaqueros anchos oscuros", CLOTHES_LEGS, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "deportivo recogido blanco", CLOTHES_LEGS, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal negro cinturon blanco", CLOTHES_LEGS, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaquero pirata oscuro", CLOTHES_LEGS, 4, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "corto a cuadros", CLOTHES_LEGS, 5, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal negro", CLOTHES_LEGS, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "falda negra", CLOTHES_LEGS, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "minifalda negra", CLOTHES_LEGS, 8, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "minifalda negra con motivos", CLOTHES_LEGS, 9, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "deportivo corto blanco y celeste", CLOTHES_LEGS, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaquero pirata marron", CLOTHES_LEGS, 11, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "minifalda volantes a cuadros", CLOTHES_LEGS, 12, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "corto gris", CLOTHES_LEGS, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "bikini negro", CLOTHES_LEGS, 15, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "corto amarillo", CLOTHES_LEGS, 16, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "bikini blanco", CLOTHES_LEGS, 17, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "falda roja", CLOTHES_LEGS, 18, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "interior encaje blanca", CLOTHES_LEGS, 19, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "interior encaje blanca con liguero y media", CLOTHES_LEGS, 20, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "bikini rojo", CLOTHES_LEGS, 21, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "recto blanco", CLOTHES_LEGS, 23, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "falda comic", CLOTHES_LEGS, 24, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "corto vaquero", CLOTHES_LEGS, 25, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "minifalda leopardo", CLOTHES_LEGS, 26, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "latex negro", CLOTHES_LEGS, 27, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "minifalda rayas roja y blanca", CLOTHES_LEGS, 28, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho con agarres marron", CLOTHES_LEGS, 29, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal pirata negro", CLOTHES_LEGS, 30, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "leggins rojo", CLOTHES_LEGS, 31, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho negro con rodilleras", CLOTHES_LEGS, 33, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal negro hebilla dorada", CLOTHES_LEGS, 34, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho verde con reflectante", CLOTHES_LEGS, 35, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "falda gris", CLOTHES_LEGS, 36, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal negro", CLOTHES_LEGS, 37, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho rojo", CLOTHES_LEGS, 38, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho marron cinturon oscuro", CLOTHES_LEGS, 41, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho con agarres negro", CLOTHES_LEGS, 42, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaquero negro roto frontal", CLOTHES_LEGS, 43, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaquero negro roto lateral", CLOTHES_LEGS, 44, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho verde militar", CLOTHES_LEGS, 45, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal negro", CLOTHES_LEGS, 47, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho marron rodilleras cinturon negro", CLOTHES_LEGS, 48, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal marron cinturon negro", CLOTHES_LEGS, 49, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "recto blanco", CLOTHES_LEGS, 50, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "leggins blanco", CLOTHES_LEGS, 51, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "recto rojo oscuro", CLOTHES_LEGS, 52, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal oscuro con flores marrones", CLOTHES_LEGS, 53, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "leggins rojo oscuro", CLOTHES_LEGS, 54, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "leggins oscuro con flores marrones", CLOTHES_LEGS, 55, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "bikini rosa", CLOTHES_LEGS, 56, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "falda blanca con lazo", CLOTHES_LEGS, 57, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "chandal negro rayas blancas lateral", CLOTHES_LEGS, 58, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal a cuadros rojo", CLOTHES_LEGS, 60, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "culotte encaje blanco y negro", CLOTHES_LEGS, 62, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "interior blanco y legro con liguero y medias", CLOTHES_LEGS, 63, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal camel", CLOTHES_LEGS, 64, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "chandal azul rayas blancas lateral", CLOTHES_LEGS, 66, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal blanco con rayas grises", CLOTHES_LEGS, 67, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "chandal negro y blanco", CLOTHES_LEGS, 68, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "ancho negro con calaveras blancas", CLOTHES_LEGS, 71, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaquero pegado oscuro", CLOTHES_LEGS, 73, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaquero rasgado oscuro", CLOTHES_LEGS, 74, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaquero pegado negro", CLOTHES_LEGS, 75, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "short vaquero con medias oscuras", CLOTHES_LEGS, 78, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "chandal marron oscuro", CLOTHES_LEGS, 80, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "chandal negro", CLOTHES_LEGS, 81, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "chandal pirata marron oscuro", CLOTHES_LEGS, 82, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "chandal pirata negro", CLOTHES_LEGS, 83, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "vaquero bajos negro", CLOTHES_LEGS, 84, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "normal bajos negro", CLOTHES_LEGS, 85, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "leggins militar oscuro y rojo", CLOTHES_LEGS, 87, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "leggins rayas colores fosforitos", CLOTHES_LEGS, 88, SEX_FEMALE, 250),

            // Male pants
            new BusinessClothesModel(0, "vaquero azul oscuro cintu negro", CLOTHES_LEGS, 0, SEX_MALE, 250),
            new BusinessClothesModel(0, "vaquero bajo slip visible", CLOTHES_LEGS, 1, SEX_MALE, 250),
            new BusinessClothesModel(0, "corto cuadros blanco y negro", CLOTHES_LEGS, 2, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal blanco", CLOTHES_LEGS, 3, SEX_MALE, 250),
            new BusinessClothesModel(0, "vaquero pitillo negro", CLOTHES_LEGS, 4, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal ancho blanco", CLOTHES_LEGS, 5, SEX_MALE, 250),
            new BusinessClothesModel(0, "corto blanco", CLOTHES_LEGS, 6, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal negro cintu negro", CLOTHES_LEGS, 7, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho gris oscuro", CLOTHES_LEGS, 8, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho verde oscuro cinturon", CLOTHES_LEGS, 9, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal negro cinturon", CLOTHES_LEGS, 10, SEX_MALE, 250),
            new BusinessClothesModel(0, "corto negro", CLOTHES_LEGS, 12, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal negro cinturon", CLOTHES_LEGS, 13, SEX_MALE, 250),
            new BusinessClothesModel(0, "calzonas gris y blanco", CLOTHES_LEGS, 14, SEX_MALE, 250),
            new BusinessClothesModel(0, "corto marron claro", CLOTHES_LEGS, 15, SEX_MALE, 250),
            new BusinessClothesModel(0, "corto rosa y azul", CLOTHES_LEGS, 16, SEX_MALE, 250),
            new BusinessClothesModel(0, "corto marron oscuro", CLOTHES_LEGS, 17, SEX_MALE, 250),
            new BusinessClothesModel(0, "calzonas amarillo", CLOTHES_LEGS, 18, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal rojo con cinturon negro", CLOTHES_LEGS, 19, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal blanco cinturon negro", CLOTHES_LEGS, 20, SEX_MALE, 250),
            new BusinessClothesModel(0, "slip negro corazones rojos", CLOTHES_LEGS, 21, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal gris", CLOTHES_LEGS, 22, SEX_MALE, 250),
            new BusinessClothesModel(0, "pitillo negro", CLOTHES_LEGS, 24, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal negro hebilla negra", CLOTHES_LEGS, 25, SEX_MALE, 250),
            new BusinessClothesModel(0, "cuero negro", CLOTHES_LEGS, 26, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho amarillo", CLOTHES_LEGS, 27, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho rayas rojas y blancas", CLOTHES_LEGS, 29, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho verde oscuro agarres", CLOTHES_LEGS, 30, SEX_MALE, 250),
            new BusinessClothesModel(0, "pitillo negro ancho", CLOTHES_LEGS, 31, SEX_MALE, 250),
            new BusinessClothesModel(0, "ceñido rojo", CLOTHES_LEGS, 32, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho negro rodilleras", CLOTHES_LEGS, 34, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho verde oscuro reflectante", CLOTHES_LEGS, 36, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal marron cinturon oscuro", CLOTHES_LEGS, 37, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho rojo oscuro", CLOTHES_LEGS, 38, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho negro agarres", CLOTHES_LEGS, 41, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal corto negro", CLOTHES_LEGS, 42, SEX_MALE, 250),
            new BusinessClothesModel(0, "vaquero normal oscuro", CLOTHES_LEGS, 43, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal ajustado negro", CLOTHES_LEGS, 45, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho marron rodilleras", CLOTHES_LEGS, 46, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho marron cinturon negro", CLOTHES_LEGS, 47, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal marron claro cinturon negro", CLOTHES_LEGS, 48, SEX_MALE, 250),
            new BusinessClothesModel(0, "pitillo marron claro cinturon negro", CLOTHES_LEGS, 49, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal rojo oscuro cinturon negro", CLOTHES_LEGS, 50, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal oscuro flores marron", CLOTHES_LEGS, 51, SEX_MALE, 250),
            new BusinessClothesModel(0, "pitillo rojo oscuro cinturon negro", CLOTHES_LEGS, 52, SEX_MALE, 250),
            new BusinessClothesModel(0, "pitillo oscuro flores marron", CLOTHES_LEGS, 53, SEX_MALE, 250),
            new BusinessClothesModel(0, "corto oscuro rayas azul oscuro", CLOTHES_LEGS, 54, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal oscuro rayas blancas", CLOTHES_LEGS, 55, SEX_MALE, 250),
            new BusinessClothesModel(0, "falda blanca lazo", CLOTHES_LEGS, 56, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal a cuadros rojo", CLOTHES_LEGS, 58, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal rayas azul oscuro y negro", CLOTHES_LEGS, 60, SEX_MALE, 250),
            new BusinessClothesModel(0, "calzonas blancas", CLOTHES_LEGS, 61, SEX_MALE, 250),
            new BusinessClothesModel(0, "pirata negro cinturon amarillo", CLOTHES_LEGS, 62, SEX_MALE, 250),
            new BusinessClothesModel(0, "vaquero ancho oscuro", CLOTHES_LEGS, 63, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal ancho azul rayas blancas", CLOTHES_LEGS, 64, SEX_MALE, 250),
            new BusinessClothesModel(0, "normal blanco a rayas", CLOTHES_LEGS, 65, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal negro y blanco", CLOTHES_LEGS, 66, SEX_MALE, 250),
            new BusinessClothesModel(0, "ancho negro con calaveras blancas", CLOTHES_LEGS, 69, SEX_MALE, 250),
            new BusinessClothesModel(0, "cuero negro", CLOTHES_LEGS, 71, SEX_MALE, 250),
            new BusinessClothesModel(0, "vaquero ancho oscuro cinturon negro", CLOTHES_LEGS, 75, SEX_MALE, 250),
            new BusinessClothesModel(0, "vaquero rasgado", CLOTHES_LEGS, 76, SEX_MALE, 250),
            new BusinessClothesModel(0, "pitillo con motivos fosforito", CLOTHES_LEGS, 77, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal rojo oscuro", CLOTHES_LEGS, 78, SEX_MALE, 250),
            new BusinessClothesModel(0, "chandal pitillo negro", CLOTHES_LEGS, 79, SEX_MALE, 250),
            new BusinessClothesModel(0, "pirata marron oscuro", CLOTHES_LEGS, 80, SEX_MALE, 250),
            new BusinessClothesModel(0, "pirata negro", CLOTHES_LEGS, 81, SEX_MALE, 250),
            new BusinessClothesModel(0, "vaquero oscuro pitillo", CLOTHES_LEGS, 82, SEX_MALE, 250),
            new BusinessClothesModel(0, "pitillo negro", CLOTHES_LEGS, 83, SEX_MALE, 250),
            new BusinessClothesModel(0, "ajustado con motivos coloridos", CLOTHES_LEGS, 85, SEX_MALE, 250),

            // Bags
            new BusinessClothesModel(0, "Gris, blanca y negra con rayas azules", CLOTHES_BAGS, 1, SEX_NONE, 250),
            new BusinessClothesModel(0, "Bandera EEUU", CLOTHES_BAGS, 10, SEX_NONE, 250),
            new BusinessClothesModel(0, "Blanca cruz azul", CLOTHES_BAGS, 21, SEX_NONE, 250),
            new BusinessClothesModel(0, "Negra", CLOTHES_BAGS, 31, SEX_NONE, 250),
            new BusinessClothesModel(0, "Marron grande", CLOTHES_BAGS, 40, SEX_NONE, 250),
            new BusinessClothesModel(0, "Negra grande", CLOTHES_BAGS, 44, SEX_NONE, 250),
            new BusinessClothesModel(0, "Verde y negra", CLOTHES_BAGS, 52, SEX_NONE, 250),

            // Female shoes
            new BusinessClothesModel(0, "Tacon redondo negro", CLOTHES_FEET, 0, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Zapatillas blanca y gris", CLOTHES_FEET, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botas pelito marron", CLOTHES_FEET, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Converse negra y blanca tobillo bajo", CLOTHES_FEET, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Deportivas gris oscuro y blanco", CLOTHES_FEET, 4, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chanclas negras", CLOTHES_FEET, 5, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Tacon punta negro", CLOTHES_FEET, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botines negros", CLOTHES_FEET, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botines abiertos negros", CLOTHES_FEET, 8, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botas largas negras", CLOTHES_FEET, 9, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Deportivas negro y morado", CLOTHES_FEET, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Zapatillas morado y blanco", CLOTHES_FEET, 11, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Plano negro", CLOTHES_FEET, 13, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Tacon tiras negras", CLOTHES_FEET, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sandalia negro y plata", CLOTHES_FEET, 15, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chanclas grises", CLOTHES_FEET, 16, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Duende verde", CLOTHES_FEET, 17, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Tacon redondo gris", CLOTHES_FEET, 18, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Tacon redondo marron", CLOTHES_FEET, 19, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Tacon punta leopardo", CLOTHES_FEET, 20, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botas amarillas", CLOTHES_FEET, 21, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botines marron", CLOTHES_FEET, 22, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Tacon redondo azul", CLOTHES_FEET, 23, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botas negras", CLOTHES_FEET, 24, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botas negras con tachuelas metal", CLOTHES_FEET, 25, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Zapatillas negra", CLOTHES_FEET, 27, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Zapatillas negra marca lateral", CLOTHES_FEET, 28, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Normal punta", CLOTHES_FEET, 29, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botines negros con hebilla", CLOTHES_FEET, 30, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Zapatillas doradas", CLOTHES_FEET, 31, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Deportivas amarillo, gris, negro y blanco", CLOTHES_FEET, 32, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Converse amarillo y blanco calentadores negros", CLOTHES_FEET, 33, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Descalza", CLOTHES_FEET, 35, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botas marrones", CLOTHES_FEET, 36, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Normal marron oscuro", CLOTHES_FEET, 37, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bota cowgirl marron punta", CLOTHES_FEET, 38, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Normal cowgirl marron punta", CLOTHES_FEET, 39, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Tacon redondo marron claro", CLOTHES_FEET, 42, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botines amarillos", CLOTHES_FEET, 43, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botines amarillo y negro", CLOTHES_FEET, 44, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bota cowgirl celeste punta", CLOTHES_FEET, 45, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Normal cowgirl celeste punta", CLOTHES_FEET, 46, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Zapatillas blanca y azul", CLOTHES_FEET, 47, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Botas verde y negro", CLOTHES_FEET, 48, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Converse negra y blanca tobillo alto", CLOTHES_FEET, 49, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Converse amarilla y blanca tobillo alto", CLOTHES_FEET, 50, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bota marron oscuro hebilla", CLOTHES_FEET, 51, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Normal marron oscuro", CLOTHES_FEET, 52, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bota marron talon alto", CLOTHES_FEET, 53, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bota negra tachuelas y cremallera", CLOTHES_FEET, 54, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Normal negro tachuelas", CLOTHES_FEET, 55, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bota negra hebilla y cremallera", CLOTHES_FEET, 56, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Normal negra hebilla", CLOTHES_FEET, 57, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Deportivas negra con rayas amarillo fosforito", CLOTHES_FEET, 58, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Plano marron", CLOTHES_FEET, 59, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Zapatillas camel", CLOTHES_FEET, 60, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Plano negro rayas rosa y celeste", CLOTHES_FEET, 61, SEX_FEMALE, 250),

            // Male shoes
            new BusinessClothesModel(0, "Zapatillas cuadros negros y blancos tobillo alto", CLOTHES_FEET, 0, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas negra suela blanca", CLOTHES_FEET, 1, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas cuadros negros y blancos tobillo bajo", CLOTHES_FEET, 2, SEX_MALE, 250),
            new BusinessClothesModel(0, "Normal marron oscuro y gris", CLOTHES_FEET, 3, SEX_MALE, 250),
            new BusinessClothesModel(0, "Converse azul oscuro tobillo alto", CLOTHES_FEET, 4, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chanclas negra y blanca", CLOTHES_FEET, 5, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chanclas negras calcetines blancos", CLOTHES_FEET, 6, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas blancas calcetines altos", CLOTHES_FEET, 7, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas blancas marca calcetines altos", CLOTHES_FEET, 9, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatos negros punta calcetines altos", CLOTHES_FEET, 10, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas planas cuadros negros y blancos", CLOTHES_FEET, 11, SEX_MALE, 250),
            new BusinessClothesModel(0, "Botas marron", CLOTHES_FEET, 12, SEX_MALE, 250),
            new BusinessClothesModel(0, "Botas oscuras suela blanca", CLOTHES_FEET, 14, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota negra lisa punta", CLOTHES_FEET, 15, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chanclas negra", CLOTHES_FEET, 16, SEX_MALE, 250),
            new BusinessClothesModel(0, "Duende verde", CLOTHES_FEET, 17, SEX_MALE, 250),
            new BusinessClothesModel(0, "Normal blanco y negro calcetin alto", CLOTHES_FEET, 18, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapato blanco y negro botones negros", CLOTHES_FEET, 19, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapato marron oscuro punta calcetines altos", CLOTHES_FEET, 20, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapato marron oscuro punta calcetin bajo", CLOTHES_FEET, 21, SEX_MALE, 250),
            new BusinessClothesModel(0, "Converse azul tobillo alto", CLOTHES_FEET, 22, SEX_MALE, 250),
            new BusinessClothesModel(0, "Normal marron suela amarilla", CLOTHES_FEET, 23, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota negra", CLOTHES_FEET, 24, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota negra tachuelas", CLOTHES_FEET, 25, SEX_MALE, 250),
            new BusinessClothesModel(0, "Converse azul oscuro tobillo alto", CLOTHES_FEET, 26, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas blanca puntos negros tobillo alto", CLOTHES_FEET, 28, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas dorado tobillo alto", CLOTHES_FEET, 29, SEX_MALE, 250),
            new BusinessClothesModel(0, "Normal blanco y oscuro hebilla", CLOTHES_FEET, 30, SEX_MALE, 250),
            new BusinessClothesModel(0, "Deportivas amarillo gris blanco negro", CLOTHES_FEET, 31, SEX_MALE, 250),
            new BusinessClothesModel(0, "Deportivas negro y blanco", CLOTHES_FEET, 32, SEX_MALE, 250),
            new BusinessClothesModel(0, "Descalzo", CLOTHES_FEET, 34, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota marron tobillo alto", CLOTHES_FEET, 35, SEX_MALE, 250),
            new BusinessClothesModel(0, "Normal marron oscuro hebilla dorada", CLOTHES_FEET, 36, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota cowboy alta punta", CLOTHES_FEET, 37, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota cowboy baja punta", CLOTHES_FEET, 38, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapato azul y gris calcetin alto", CLOTHES_FEET, 40, SEX_MALE, 250),
            new BusinessClothesModel(0, "Pantufla rojo oscuro y negro", CLOTHES_FEET, 41, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas grisaceo", CLOTHES_FEET, 42, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota baja amarillo", CLOTHES_FEET, 43, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota cowboy alta azul punta", CLOTHES_FEET, 44, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota cowboy baja azul punta", CLOTHES_FEET, 45, SEX_MALE, 250),
            new BusinessClothesModel(0, "Deportivas blanca y azul", CLOTHES_FEET, 46, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota alta verde y blanca", CLOTHES_FEET, 47, SEX_MALE, 250),
            new BusinessClothesModel(0, "Converse negro y blanco tobillo alto", CLOTHES_FEET, 48, SEX_MALE, 250),
            new BusinessClothesModel(0, "Converse amarillo y blanco tobillo alto", CLOTHES_FEET, 49, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota tobillo algo negra", CLOTHES_FEET, 50, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatos bajos negro", CLOTHES_FEET, 51, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota redonda marron", CLOTHES_FEET, 52, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bota negra tobillo alto tachuelas", CLOTHES_FEET, 53, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapato negro tobillo bajo tachuelas", CLOTHES_FEET, 54, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas negras rayas amarillo fosforito", CLOTHES_FEET, 55, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapato marron tobillo bajo suela negra", CLOTHES_FEET, 56, SEX_MALE, 250),
            new BusinessClothesModel(0, "Zapatillas camel", CLOTHES_FEET, 57, SEX_MALE, 250),
            new BusinessClothesModel(0, "Plano negro rayas rojas y celestes", CLOTHES_FEET, 58, SEX_MALE, 250),

            // Female accessories
            new BusinessClothesModel(0, "Pendientes aro ancho dorado", CLOTHES_ACCESSORIES, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Pendientes aro fino dorado", CLOTHES_ACCESSORIES, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Muñequera mano derecha negra", CLOTHES_ACCESSORIES, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Pulseras anchas mano derecha cuadrados negro y blanco", CLOTHES_ACCESSORIES, 4, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Muñequera mano derecha cuadrados negro y blanco", CLOTHES_ACCESSORIES, 5, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Colgante herradura dorada gema interior oscura", CLOTHES_ACCESSORIES, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Colgantes cuerdas negra y dorado con circulo y corazon dorado", CLOTHES_ACCESSORIES, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Palestina negra y blanca", CLOTHES_ACCESSORIES, 9, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Pulseras anchas mano derecha flores", CLOTHES_ACCESSORIES, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Colgantes cuarda negra y dorado con circulo dorado y corazon oscuro", CLOTHES_ACCESSORIES, 11, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Collar perlas blancas", CLOTHES_ACCESSORIES, 12, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Pañuelo negro circulos blancos", CLOTHES_ACCESSORIES, 13, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Muñequera mano derecha tachuelas metal", CLOTHES_ACCESSORIES, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Palestina roja y negra", CLOTHES_ACCESSORIES, 15, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bufanda buscando a Wally", CLOTHES_ACCESSORIES, 17, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Corbata negra", CLOTHES_ACCESSORIES, 20, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Corbata blanca", CLOTHES_ACCESSORIES, 21, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Corbata negra ajustada", CLOTHES_ACCESSORIES, 22, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Pajarita negra", CLOTHES_ACCESSORIES, 23, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "", CLOTHES_ACCESSORIES, 24, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro con colgante G", CLOTHES_ACCESSORIES, 29, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante calavera oro ojos rojos", CLOTHES_ACCESSORIES, 30, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena plata colgante calavera plata ojos rojos", CLOTHES_ACCESSORIES, 31, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro placa oro", CLOTHES_ACCESSORIES, 32, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro € oro", CLOTHES_ACCESSORIES, 33, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena plata colgante plata", CLOTHES_ACCESSORIES, 34, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante ancho oro", CLOTHES_ACCESSORIES, 35, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante $ oro", CLOTHES_ACCESSORIES, 36, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante calavera ojos rojos exterior", CLOTHES_ACCESSORIES, 37, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena plata colgante enmascarado plata exterior", CLOTHES_ACCESSORIES, 38, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante placa plata exterior", CLOTHES_ACCESSORIES, 39, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante C exterior", CLOTHES_ACCESSORIES, 40, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante DIX exterior", CLOTHES_ACCESSORIES, 41, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante letras oro exterior", CLOTHES_ACCESSORIES, 42, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro claro sin colgante", CLOTHES_ACCESSORIES, 53, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro sin colgante", CLOTHES_ACCESSORIES, 54, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro ancha", CLOTHES_ACCESSORIES, 55, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro claro ancha", CLOTHES_ACCESSORIES, 56, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Palestina marron oscuro y negro", CLOTHES_ACCESSORIES, 83, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Collar perlas marrones", CLOTHES_ACCESSORIES, 84, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Auriculares rojo y blanco", CLOTHES_ACCESSORIES, 85, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Corbata azul y rosa", CLOTHES_ACCESSORIES, 86, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Corbata verde", CLOTHES_ACCESSORIES, 87, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Tirantes negros", CLOTHES_ACCESSORIES, 88, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante estrella roja y dorada exterior", CLOTHES_ACCESSORIES, 90, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante estrella dorada exterior", CLOTHES_ACCESSORIES, 92, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Collar perlas marron claro", CLOTHES_ACCESSORIES, 93, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Auriculares blanco y azul", CLOTHES_ACCESSORIES, 94, SEX_FEMALE, 250),

            // Male accessories
            new BusinessClothesModel(0, "Corbata blanca ajustada", CLOTHES_ACCESSORIES, 10, SEX_MALE, 250),
            new BusinessClothesModel(0, "Pajarita cuadros blanco y negro", CLOTHES_ACCESSORIES, 11, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata blanca", CLOTHES_ACCESSORIES, 12, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena plata", CLOTHES_ACCESSORIES, 16, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena plata exterior", CLOTHES_ACCESSORIES, 17, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata roja ancha", CLOTHES_ACCESSORIES, 18, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata roja fina", CLOTHES_ACCESSORIES, 19, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata rojo oscuro", CLOTHES_ACCESSORIES, 20, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata azul ancha", CLOTHES_ACCESSORIES, 21, SEX_MALE, 250),
            new BusinessClothesModel(0, "Pajarita blanca", CLOTHES_ACCESSORIES, 22, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata azul fina", CLOTHES_ACCESSORIES, 23, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata blanca ancha", CLOTHES_ACCESSORIES, 24, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata blanca fina", CLOTHES_ACCESSORIES, 25, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bufanda blanca", CLOTHES_ACCESSORIES, 30, SEX_MALE, 250),
            new BusinessClothesModel(0, "Pajarita roja blanca y azul", CLOTHES_ACCESSORIES, 32, SEX_MALE, 250),
            new BusinessClothesModel(0, "Bufanda buscando a Wally", CLOTHES_ACCESSORIES, 34, SEX_MALE, 250),
            new BusinessClothesModel(0, "Pajarita negra", CLOTHES_ACCESSORIES, 36, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata negra ancha", CLOTHES_ACCESSORIES, 37, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata negra ajustada", CLOTHES_ACCESSORIES, 38, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata negra suelta", CLOTHES_ACCESSORIES, 39, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante G", CLOTHES_ACCESSORIES, 42, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante calavera", CLOTHES_ACCESSORIES, 43, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena plata colgante circulo", CLOTHES_ACCESSORIES, 44, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante placa", CLOTHES_ACCESSORIES, 45, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante oro claro", CLOTHES_ACCESSORIES, 46, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro medallon", CLOTHES_ACCESSORIES, 47, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena plata colgante enmascarado", CLOTHES_ACCESSORIES, 51, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro claro", CLOTHES_ACCESSORIES, 74, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro oscuro", CLOTHES_ACCESSORIES, 75, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro ancha oscuro", CLOTHES_ACCESSORIES, 76, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena grande clara", CLOTHES_ACCESSORIES, 85, SEX_MALE, 250),
            new BusinessClothesModel(0, "Palestina marron y negro", CLOTHES_ACCESSORIES, 112, SEX_MALE, 250),
            new BusinessClothesModel(0, "Collar perlas marron", CLOTHES_ACCESSORIES, 113, SEX_MALE, 250),
            new BusinessClothesModel(0, "Auriculares rojo y blanco", CLOTHES_ACCESSORIES, 114, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata azul y rosa", CLOTHES_ACCESSORIES, 115, SEX_MALE, 250),
            new BusinessClothesModel(0, "Corbata verde", CLOTHES_ACCESSORIES, 117, SEX_MALE, 250),
            new BusinessClothesModel(0, "Pajarita gargantilla negro", CLOTHES_ACCESSORIES, 118, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante estrella rojo", CLOTHES_ACCESSORIES, 119, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante estrella oro", CLOTHES_ACCESSORIES, 120, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante estrella rojo exterior", CLOTHES_ACCESSORIES, 121, SEX_MALE, 250),
            new BusinessClothesModel(0, "Cadena oro colgante estrella oro exterior", CLOTHES_ACCESSORIES, 122, SEX_MALE, 250),
            new BusinessClothesModel(0, "Collar perlas marron claro", CLOTHES_ACCESSORIES, 123, SEX_MALE, 250),
            new BusinessClothesModel(0, "Auriculares azul y blanco", CLOTHES_ACCESSORIES, 124, SEX_MALE, 250),

            // Female torsos
            new BusinessClothesModel(0, "Guantes largos morado", CLOTHES_TORSO, 16, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes verde", CLOTHES_TORSO, 17, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes negro", CLOTHES_TORSO, 45, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes negros dedos fuera", CLOTHES_TORSO, 71, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes negros exterior", CLOTHES_TORSO, 31, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes amarillo y blanco", CLOTHES_TORSO, 84, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes blancos", CLOTHES_TORSO, 97, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes celeste", CLOTHES_TORSO, 110, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes verde oscuro", CLOTHES_TORSO, 126, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes verde y blanco moto", CLOTHES_TORSO, 127, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Guantes rosa y blanco moto", CLOTHES_TORSO, 128, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes", CLOTHES_TORSO, 0, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 2", CLOTHES_TORSO, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 3", CLOTHES_TORSO, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 4", CLOTHES_TORSO, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 5", CLOTHES_TORSO, 5, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 6", CLOTHES_TORSO, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 7", CLOTHES_TORSO, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 8", CLOTHES_TORSO, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 9", CLOTHES_TORSO, 12, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 10", CLOTHES_TORSO, 13, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 11", CLOTHES_TORSO, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 12", CLOTHES_TORSO, 131, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sin guantes 13", CLOTHES_TORSO, 161, SEX_FEMALE, 250),
             new BusinessClothesModel(0, "Sin guantes 14", CLOTHES_TORSO, 130, SEX_FEMALE, 250),
            ...
            new BusinessClothesModel(0, "Sin guantes", CLOTHES_TORSO, 0, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 2", CLOTHES_TORSO, 0, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 3", CLOTHES_TORSO, 1, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 4", CLOTHES_TORSO, 2, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 5", CLOTHES_TORSO, 3, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 6", CLOTHES_TORSO, 4, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 7", CLOTHES_TORSO, 5, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 8", CLOTHES_TORSO, 6, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 9", CLOTHES_TORSO, 7, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 10", CLOTHES_TORSO, 8, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 11", CLOTHES_TORSO, 9, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 12", CLOTHES_TORSO, 10, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 13", CLOTHES_TORSO, 11, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 14", CLOTHES_TORSO, 12, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 15", CLOTHES_TORSO, 13, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 16", CLOTHES_TORSO, 14, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 17", CLOTHES_TORSO, 15, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 18", CLOTHES_TORSO, 112, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 19", CLOTHES_TORSO, 113, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin Guantes 20", CLOTHES_TORSO, 114, SEX_MALE, 250),

            // Female tops
            new BusinessClothesModel(0, "Camiseta manga corta rojo oscuro y gris", CLOTHES_TOPS, 0, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta vaquera remangada abierta", CLOTHES_TOPS, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca hombro al aire", CLOTHES_TOPS, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera blanca", CLOTHES_TOPS, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes cuadros negro y blanco", CLOTHES_TOPS, 4, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Top blanco", CLOTHES_TOPS, 5, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra y blanca remangada", CLOTHES_TOPS, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta gris remangada abierta", CLOTHES_TOPS, 8, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa negra", CLOTHES_TOPS, 9, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera negra rayas morado y blanco", CLOTHES_TOPS, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes celeste negra y blanca", CLOTHES_TOPS, 11, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes cuadros negro y blanco", CLOTHES_TOPS, 12, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Palabra de honor negro", CLOTHES_TOPS, 13, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Polo lacoste blanco", CLOTHES_TOPS, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bikini negro", CLOTHES_TOPS, 15, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes roja", CLOTHES_TOPS, 16, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa hawaiana", CLOTHES_TOPS, 17, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bikini blanco", CLOTHES_TOPS, 18, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta mama noel", CLOTHES_TOPS, 19, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta roja y blanca remangada", CLOTHES_TOPS, 20, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Vestido volantes de morado a blanco", CLOTHES_TOPS, 21, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Palabra de honor blanco encaje", CLOTHES_TOPS, 22, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca", CLOTHES_TOPS, 23, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta blanca y negra remangada", CLOTHES_TOPS, 24, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta roja abierta", CLOTHES_TOPS, 25, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes griega camel", CLOTHES_TOPS, 26, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa blanca por dentro de pantalon", CLOTHES_TOPS, 27, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaquetilla gris tirantes", CLOTHES_TOPS, 28, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta azul y negra abierta remangada", CLOTHES_TOPS, 31, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes leopardo", CLOTHES_TOPS, 32, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Top blanco rayas negras", CLOTHES_TOPS, 33, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta camuflaje abierta", CLOTHES_TOPS, 34, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta corta amarilla y blanca remangada", CLOTHES_TOPS, 35, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes negra FIST", CLOTHES_TOPS, 36, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Vestido flores rosas", CLOTHES_TOPS, 37, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta verde hombro fuera", CLOTHES_TOPS, 38, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga EEUU", CLOTHES_TOPS, 39, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga mama noel", CLOTHES_TOPS, 40, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta azul hombro fuera", CLOTHES_TOPS, 41, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta militar enganches verde", CLOTHES_TOPS, 42, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga rojo y blanco", CLOTHES_TOPS, 45, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta militar enganches negra", CLOTHES_TOPS, 47, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta gris", CLOTHES_TOPS, 49, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera negra cuello ancho", CLOTHES_TOPS, 50, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta gris abierta", CLOTHES_TOPS, 52, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta gris remangada", CLOTHES_TOPS, 53, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron", CLOTHES_TOPS, 54, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero negro", CLOTHES_TOPS, 55, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa negra manga corta", CLOTHES_TOPS, 56, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 57, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra cerrada ", CLOTHES_TOPS, 58, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta rota", CLOTHES_TOPS, 59, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta rota roja y negra manga larga", CLOTHES_TOPS, 60, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga gris", CLOTHES_TOPS, 61, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra con capucha puesta", CLOTHES_TOPS, 62, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra con capucha quitada", CLOTHES_TOPS, 63, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta larga veig abierta", CLOTHES_TOPS, 64, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta roja con pelitos en cuello maron", CLOTHES_TOPS, 65, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa negra escotada hombreras", CLOTHES_TOPS, 66, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta amarilla hombro fuera", CLOTHES_TOPS, 67, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta tonos amarillos naranja y marron", CLOTHES_TOPS, 68, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra con hebillas", CLOTHES_TOPS, 69, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta veig cerrada por cinturon", CLOTHES_TOPS, 70, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa cuadritos veig, amarillo, marron y negro remangada", CLOTHES_TOPS, 71, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera roja y blanca W", CLOTHES_TOPS, 72, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca por dentro del pantalon", CLOTHES_TOPS, 73, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Top blanco poco ajustado", CLOTHES_TOPS, 74, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta amarilla y negra por dentro del pantalon", CLOTHES_TOPS, 75, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa larga gris y rayas amarillas", CLOTHES_TOPS, 76, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa larga negra", CLOTHES_TOPS, 77, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera negra capucha", CLOTHES_TOPS, 78, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Jersey negro", CLOTHES_TOPS, 79, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta rojo oscuro y blanco sin letra", CLOTHES_TOPS, 80, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta rojo y blanco P", CLOTHES_TOPS, 81, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa negra sencilla", CLOTHES_TOPS, 83, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS", CLOTHES_TOPS, 84, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS por dentro del pantalon", CLOTHES_TOPS, 85, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa vaquera por dentro del pantalon", CLOTHES_TOPS, 86, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera azul con franja blanca F", CLOTHES_TOPS, 87, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta marron", CLOTHES_TOPS, 88, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron por dentro del pantalon", CLOTHES_TOPS, 89, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta blanca abierta", CLOTHES_TOPS, 90, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta blanca cerrada", CLOTHES_TOPS, 91, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta roja abierta", CLOTHES_TOPS, 92, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta roja cerrada", CLOTHES_TOPS, 93, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta oscura con flores marrones abierta", CLOTHES_TOPS, 94, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta oscura con flores marrones cerrada", CLOTHES_TOPS, 95, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa blanca con flores", CLOTHES_TOPS, 96, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta larga azul oscuro", CLOTHES_TOPS, 97, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa blanca cerrada con bolsillos grandes", CLOTHES_TOPS, 98, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta roja y negra larga", CLOTHES_TOPS, 99, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca sin mangas", CLOTHES_TOPS, 100, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Bikini rosa", CLOTHES_TOPS, 101, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron oscuro larga cerrada", CLOTHES_TOPS, 102, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro del pantalon", CLOTHES_TOPS, 103, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron claro cerrada", CLOTHES_TOPS, 104, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa blanca ombligo fuera", CLOTHES_TOPS, 105, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera roja blanca y negra", CLOTHES_TOPS, 106, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Gabardina negra abierta", CLOTHES_TOPS, 107, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Mama noel sucio", CLOTHES_TOPS, 108, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa cerrada roja y negra", CLOTHES_TOPS, 109, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero negra y verde", CLOTHES_TOPS, 110, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Palabra de honor marron y blanco", CLOTHES_TOPS, 111, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Vestido azul y negro", CLOTHES_TOPS, 112, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Vestido marron y negro", CLOTHES_TOPS, 113, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Vestido rojo y dorado", CLOTHES_TOPS, 114, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Vestido verde oscuro y amarillo", CLOTHES_TOPS, 115, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Vestido blanco y gris", CLOTHES_TOPS, 116, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca sin manga por dentro del pantalon", CLOTHES_TOPS, 117, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca sin manga", CLOTHES_TOPS, 118, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Polo blanco grande", CLOTHES_TOPS, 119, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa de cuadros negro y azulado abierto", CLOTHES_TOPS, 120, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa de cuadros negro y azulado cerrado", CLOTHES_TOPS, 121, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta camel cerrada larga", CLOTHES_TOPS, 122, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta rayas negras y blancas", CLOTHES_TOPS, 123, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta larga verde", CLOTHES_TOPS, 125, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta negra larga", CLOTHES_TOPS, 126, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra triangulo rojo y blanco", CLOTHES_TOPS, 127, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Polo azul LIBERTY", CLOTHES_TOPS, 128, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Polo azul LIBERTY por dentro de pantalones", CLOTHES_TOPS, 129, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Polo blanco y gris remangado", CLOTHES_TOPS, 130, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera negra LIBERTY con capucha", CLOTHES_TOPS, 131, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa remangada negra flores amarillas", CLOTHES_TOPS, 132, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta larga abierta gris oscuro", CLOTHES_TOPS, 133, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Jersey sin mangas rombos negros gris y blanco", CLOTHES_TOPS, 134, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron oscuro con cinturon", CLOTHES_TOPS, 135, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro de pantalones", CLOTHES_TOPS, 136, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta azul larga escotada", CLOTHES_TOPS, 137, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera azul con franjas blancas", CLOTHES_TOPS, 138, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta larga abierta negra", CLOTHES_TOPS, 139, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera verde y blanca", CLOTHES_TOPS, 140, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta celeste", CLOTHES_TOPS, 141, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa celeste manga larga", CLOTHES_TOPS, 142, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta celeste cerrada", CLOTHES_TOPS, 143, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera azul y blanca cerrada", CLOTHES_TOPS, 144, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta verde y blanca", CLOTHES_TOPS, 145, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta veig y EEUU", CLOTHES_TOPS, 146, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra y amarilla", CLOTHES_TOPS, 147, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa abierta oscura con letras amarillas", CLOTHES_TOPS, 148, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta NAGASAK rosa", CLOTHES_TOPS, 149, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera negra y roja", CLOTHES_TOPS, 150, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera marron italia", CLOTHES_TOPS, 151, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta amarilla EEUU", CLOTHES_TOPS, 152, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaquetilla negra abierta sin mangas", CLOTHES_TOPS, 154, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaquetilla sin mangas negra con cremallera", CLOTHES_TOPS, 155, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaquetilla negra sin mangas con botones", CLOTHES_TOPS, 156, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaquetilla negra sin mangas abierta cremallera", CLOTHES_TOPS, 157, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta de cuero negra cerrada", CLOTHES_TOPS, 158, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta de cuero negra sin mangas cerrada", CLOTHES_TOPS, 159, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa cuero negro abierto", CLOTHES_TOPS, 160, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa larga cuero negro media manga", CLOTHES_TOPS, 161, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta azul oscuro manga serpiente blanco", CLOTHES_TOPS, 162, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero negra abierta", CLOTHES_TOPS, 163, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Abrigo rojo michelin", CLOTHES_TOPS, 164, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta oliva", CLOTHES_TOPS, 165, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa vaquera abierta", CLOTHES_TOPS, 166, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa vaquera abierta sin mangas", CLOTHES_TOPS, 167, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta corta sin mangas negra", CLOTHES_TOPS, 168, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta corta negra", CLOTHES_TOPS, 169, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Top negro suelto", CLOTHES_TOPS, 170, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa vaquera recogida", CLOTHES_TOPS, 171, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Abrigo negro capucha", CLOTHES_TOPS, 172, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaquetilla tirantes pinguino", CLOTHES_TOPS, 173, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta vaquera pegatinas abierta", CLOTHES_TOPS, 174, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta vaquera sin mangas pegatina abierta", CLOTHES_TOPS, 175, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero negra pegatinas cerrada", CLOTHES_TOPS, 176, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero negra pegatinas sin mangas", CLOTHES_TOPS, 177, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa sin mangas negra pegatinas", CLOTHES_TOPS, 178, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta sin mangas azul oscuro", CLOTHES_TOPS, 179, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga negra con rayas amarillas", CLOTHES_TOPS, 180, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa rayas blancas y negras", CLOTHES_TOPS, 185, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero verde largo con capucha", CLOTHES_TOPS, 186, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero verde largo con capucha abierto", CLOTHES_TOPS, 187, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Gabardina negra larga", CLOTHES_TOPS, 189, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero camel con capucha", CLOTHES_TOPS, 190, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero largo con capucha camel", CLOTHES_TOPS, 191, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Jersey gris con rombos negros recogido", CLOTHES_TOPS, 192, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta verde camuflaje y negra abierta", CLOTHES_TOPS, 193, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Gabardina gris larga abierta", CLOTHES_TOPS, 194, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta recogida negra letras rosas", CLOTHES_TOPS, 195, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Jersey navideño", CLOTHES_TOPS, 196, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Jersey remangado gris con bits amarillos", CLOTHES_TOPS, 198, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa azul arboles blancos", CLOTHES_TOPS, 200, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera amarilla parches naranjas", CLOTHES_TOPS, 202, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta ajustada negra con rayas amarillas celestes verdes y rosa", CLOTHES_TOPS, 203, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta sin manga negra con capucha puesta", CLOTHES_TOPS, 204, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera amarilla parches naranjas con capucha puesta", CLOTHES_TOPS, 205, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Gabardina negra con capucha puesta", CLOTHES_TOPS, 206, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta sin mangas negra con cuello ancho", CLOTHES_TOPS, 207, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje sin mangas por dentro del pantalon", CLOTHES_TOPS, 208, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje sin mangas", CLOTHES_TOPS, 209, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas con capucha", CLOTHES_TOPS, 210, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas capucha puesta", CLOTHES_TOPS, 211, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado metida por pantalon", CLOTHES_TOPS, 212, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado con capucha", CLOTHES_TOPS, 214, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado con capucha puesta", CLOTHES_TOPS, 215, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero camuflaje azulado abierto", CLOTHES_TOPS, 216, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta sin mangas negro y camuflaje azulado", CLOTHES_TOPS, 217, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga negra con camuflaje azulado", CLOTHES_TOPS, 218, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado y negro abierta", CLOTHES_TOPS, 219, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado y negro sin mangas abierta", CLOTHES_TOPS, 220, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado sin mangas recogido ", CLOTHES_TOPS, 221, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado recogido", CLOTHES_TOPS, 222, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Top suelto camuflaje azulado", CLOTHES_TOPS, 223, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azulado por dentro del pantalon", CLOTHES_TOPS, 224, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta sin mangas camuflaje azulado", CLOTHES_TOPS, 225, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta sin mangas camuflaje azulado metido por pantalon", CLOTHES_TOPS, 226, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero marron largo cerrado", CLOTHES_TOPS, 227, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chubasquero marron largo cerrado capucha puesta", CLOTHES_TOPS, 228, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaquetilla camuflaje azulado sin manga", CLOTHES_TOPS, 229, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Sudadera azul y camuflaje azulado mangas largas", CLOTHES_TOPS, 230, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta mangas largas camuflaje azulado", CLOTHES_TOPS, 231, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camisa camuflaje azulado", CLOTHES_TOPS, 232, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta sin mangas cerrada por cremallera negra", CLOTHES_TOPS, 233, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra con mangas largas cerrada con cremallera", CLOTHES_TOPS, 234, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca y mangas azules con letras", CLOTHES_TOPS, 235, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "Camiseta negra normal", CLOTHES_TOPS, 236, SEX_FEMALE, 250),
            
            // Male tops
            new BusinessClothesModel(0, "Camiseta roja mangas gris", CLOTHES_TOPS, 0, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca", CLOTHES_TOPS, 1, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta sin mangas cuadros negro y blanco", CLOTHES_TOPS, 2, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa abierta blanca", CLOTHES_TOPS, 3, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa abierta negra", CLOTHES_TOPS, 4, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes blanca", CLOTHES_TOPS, 5, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera abierta negra con rayas blancas", CLOTHES_TOPS, 6, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera abierta blanca", CLOTHES_TOPS, 7, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga remangada azul y rojo", CLOTHES_TOPS, 8, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo blanco y negro con rayas negras", CLOTHES_TOPS, 9, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta escotada negra", CLOTHES_TOPS, 10, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla cerrada gris", CLOTHES_TOPS, 11, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa blanca", CLOTHES_TOPS, 12, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa blanca por dentro del pantalon", CLOTHES_TOPS, 13, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa azul cuadrados azul y blanca", CLOTHES_TOPS, 14, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sin camiseta", CLOTHES_TOPS, 15, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta gris", CLOTHES_TOPS, 16, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantes azul", CLOTHES_TOPS, 17, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta papa noel", CLOTHES_TOPS, 18, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta roja y blanca escote", CLOTHES_TOPS, 19, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta blanca pañuelo rojo", CLOTHES_TOPS, 20, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla gris claro sin mangas", CLOTHES_TOPS, 21, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca basica", CLOTHES_TOPS, 22, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta oliva abierta", CLOTHES_TOPS, 23, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta gris claro escote", CLOTHES_TOPS, 24, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla amarilla sin mangas", CLOTHES_TOPS, 25, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa negra remangada dentro del pantalon", CLOTHES_TOPS, 26, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta larga negra", CLOTHES_TOPS, 27, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta larga negra escote", CLOTHES_TOPS, 28, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta larga negra abierta", CLOTHES_TOPS, 29, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta rayas blanca y gris", CLOTHES_TOPS, 33, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta negra basica", CLOTHES_TOPS, 34, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta abierta negra rayas blancas", CLOTHES_TOPS, 35, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta tirantas blanco gris negro y azul", CLOTHES_TOPS, 36, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron y camel", CLOTHES_TOPS, 37, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta remangada gris y negra", CLOTHES_TOPS, 38, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo rojo azul y blanco", CLOTHES_TOPS, 39, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla sin mangas roja", CLOTHES_TOPS, 40, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa cuadros camel marron naranja", CLOTHES_TOPS, 41, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa remangada azul tirantes", CLOTHES_TOPS, 42, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta verde lima", CLOTHES_TOPS, 44, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta sin manga EEUU", CLOTHES_TOPS, 45, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta abierta azul roja y blanca", CLOTHES_TOPS, 46, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta azul basica", CLOTHES_TOPS, 47, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera bolsillos verde enganches", CLOTHES_TOPS, 48, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera negra", CLOTHES_TOPS, 49, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga papa noel", CLOTHES_TOPS, 51, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga roja y blanca", CLOTHES_TOPS, 52, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga negra por dentro del pantalon", CLOTHES_TOPS, 53, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera bolsillos negra enganches", CLOTHES_TOPS, 54, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca sucia", CLOTHES_TOPS, 56, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera gris con capucha", CLOTHES_TOPS, 57, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 58, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta gris larga abierta", CLOTHES_TOPS, 59, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta gris larga escote", CLOTHES_TOPS, 60, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera marron cerrada cremallera", CLOTHES_TOPS, 61, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra larga abierta", CLOTHES_TOPS, 62, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo negro basico", CLOTHES_TOPS, 63, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta escote negra", CLOTHES_TOPS, 64, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa roja por dentro pantalon", CLOTHES_TOPS, 65, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta cortada por abajo roja y manga negra", CLOTHES_TOPS, 66, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga blanca", CLOTHES_TOPS, 67, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera negra capucha puesta", CLOTHES_TOPS, 68, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera negra capucha quitada", CLOTHES_TOPS, 69, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta larga marron con pelito por cuello", CLOTHES_TOPS, 70, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta amarilla", CLOTHES_TOPS, 71, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina amarilla", CLOTHES_TOPS, 72, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta motivos amarillos y marron", CLOTHES_TOPS, 73, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera abierta marron motivos amarillos", CLOTHES_TOPS, 74, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera marron motivos amarillos", CLOTHES_TOPS, 75, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina camel cerrada cinturon", CLOTHES_TOPS, 76, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina gris abierta cuello levantado", CLOTHES_TOPS, 77, SEX_MALE, 250),
            new BusinessClothesModel(0, "Jersey cuadros amarillos y marron", CLOTHES_TOPS, 78, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera rojo y blanco W", CLOTHES_TOPS, 79, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta larga blanca", CLOTHES_TOPS, 80, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta larga negra", CLOTHES_TOPS, 81, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo largo gris", CLOTHES_TOPS, 82, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta larga gris rayas amarillas", CLOTHES_TOPS, 83, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera blanca letras frontal", CLOTHES_TOPS, 84, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera azul oscuro", CLOTHES_TOPS, 85, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera negra con capucha", CLOTHES_TOPS, 86, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera roja y blanca P", CLOTHES_TOPS, 87, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera roja y blanca P abierta", CLOTHES_TOPS, 88, SEX_MALE, 250),
            new BusinessClothesModel(0, "Jersey negro", CLOTHES_TOPS, 89, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera rojo oscuro y blanco", CLOTHES_TOPS, 90, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa negra larga", CLOTHES_TOPS, 92, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS", CLOTHES_TOPS, 93, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo verde oscuro ANDREAS por dentro del pantalon", CLOTHES_TOPS, 94, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa vaquera remangada por dentro del pantalon", CLOTHES_TOPS, 95, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera azul franja diagonal blanca", CLOTHES_TOPS, 96, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta marron", CLOTHES_TOPS, 97, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga marron por dentro del pantalon", CLOTHES_TOPS, 98, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta blanca abierta", CLOTHES_TOPS, 99, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta blanca escote", CLOTHES_TOPS, 100, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta rojo oscuro abierta", CLOTHES_TOPS, 101, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta rojo oscuro escote", CLOTHES_TOPS, 102, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron motivos marron claro abierta", CLOTHES_TOPS, 103, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron motivos marron claro escote", CLOTHES_TOPS, 104, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa con motivos rojos y azules", CLOTHES_TOPS, 105, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa abierta negra", CLOTHES_TOPS, 106, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta blanca bolsillos cerrada", CLOTHES_TOPS, 107, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta rojo oscuro y negro escote", CLOTHES_TOPS, 108, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta sin mangas blanca", CLOTHES_TOPS, 109, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero marron oscuro", CLOTHES_TOPS, 110, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro del pantalon", CLOTHES_TOPS, 111, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa marron claro escote", CLOTHES_TOPS, 112, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera roja blanca y negra", CLOTHES_TOPS, 113, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa escote blanca por dentro de pantalon", CLOTHES_TOPS, 114, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina marron oscuro abierta", CLOTHES_TOPS, 115, SEX_MALE, 250),
            new BusinessClothesModel(0, "Papa noel sucio", CLOTHES_TOPS, 116, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa cuadros rojo y negro", CLOTHES_TOPS, 117, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta verde y negro abierta", CLOTHES_TOPS, 118, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa rayas azul y negro escote", CLOTHES_TOPS, 119, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla sin manga azul y negro a raya", CLOTHES_TOPS, 120, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga rayas negra y blanca", CLOTHES_TOPS, 121, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 122, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo blanco", CLOTHES_TOPS, 123, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera verde oscuro cerrada", CLOTHES_TOPS, 124, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta camel", CLOTHES_TOPS, 125, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa cuadros aguamarina y negro", CLOTHES_TOPS, 126, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa cuadros aguamarina y negro abierta", CLOTHES_TOPS, 127, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta verde larga", CLOTHES_TOPS, 128, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra triangulo rojo y blanco", CLOTHES_TOPS, 129, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra triangulo rojo y blanco abierta", CLOTHES_TOPS, 130, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo LIBERTY negro", CLOTHES_TOPS, 131, SEX_MALE, 250),
            new BusinessClothesModel(0, "Polo LIBERTY negro por dentro del pantalon", CLOTHES_TOPS, 132, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa remangada marron claro por dentro de pantalon", CLOTHES_TOPS, 133, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera LIBERTY negra", CLOTHES_TOPS, 134, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa marron oscuro motivos amarillos", CLOTHES_TOPS, 135, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron oscuro larga abierta", CLOTHES_TOPS, 136, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina marron oscuro", CLOTHES_TOPS, 138, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga gris por dentro de pantalon", CLOTHES_TOPS, 139, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta azul oscuro larga escote", CLOTHES_TOPS, 140, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera azul rayas blancas", CLOTHES_TOPS, 141, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina negra larga abierta", CLOTHES_TOPS, 142, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera verde mangas blancas", CLOTHES_TOPS, 143, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa blanca y rayas celestes", CLOTHES_TOPS, 144, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta celeste a rayas", CLOTHES_TOPS, 145, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca normal", CLOTHES_TOPS, 146, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera azul oscuro manga blanca", CLOTHES_TOPS, 147, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera verde y blanco", CLOTHES_TOPS, 148, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa marron claro EEUU", CLOTHES_TOPS, 149, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera negra filos amarillos", CLOTHES_TOPS, 150, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra abierta letras amarilla", CLOTHES_TOPS, 151, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta rosa y negro manga larga", CLOTHES_TOPS, 152, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera marron oscuro y rojo", CLOTHES_TOPS, 153, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera marron Italia", CLOTHES_TOPS, 154, SEX_MALE, 250),
            new BusinessClothesModel(0, "CAmisa amarilla EEUU", CLOTHES_TOPS, 155, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla negra abierta sin manga", CLOTHES_TOPS, 157, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla negra cremallera sin manga", CLOTHES_TOPS, 158, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla negra botones sin manga", CLOTHES_TOPS, 159, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaquetilla negra cremallera abierta", CLOTHES_TOPS, 160, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra cuero", CLOTHES_TOPS, 161, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra cuero sin manga", CLOTHES_TOPS, 162, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa negra larga", CLOTHES_TOPS, 164, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa azul oscuro mangas serpiente blanco", CLOTHES_TOPS, 165, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra abierta", CLOTHES_TOPS, 166, SEX_MALE, 250),
            new BusinessClothesModel(0, "Abrigo rojo michelin", CLOTHES_TOPS, 167, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera marron oscuro capucha", CLOTHES_TOPS, 168, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa vaquera larga abierta", CLOTHES_TOPS, 169, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa vaquera abierta larga", CLOTHES_TOPS, 170, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera negra capucha", CLOTHES_TOPS, 171, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta vaquera parches", CLOTHES_TOPS, 172, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta vaquera sin mangas parches", CLOTHES_TOPS, 173, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero parches", CLOTHES_TOPS, 174, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero sin manga parches", CLOTHES_TOPS, 175, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa negra letras rojas", CLOTHES_TOPS, 176, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa azul oscuro sin manga", CLOTHES_TOPS, 177, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga negra y amarilla", CLOTHES_TOPS, 178, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero sin manga abierta", CLOTHES_TOPS, 179, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero sin manga", CLOTHES_TOPS, 180, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta cuero abierta", CLOTHES_TOPS, 181, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera negra capucha", CLOTHES_TOPS, 182, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra y blanca a rayas", CLOTHES_TOPS, 183, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta verde oscuro larga capucha", CLOTHES_TOPS, 184, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta verde oscuro larga abierta", CLOTHES_TOPS, 185, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina negra", CLOTHES_TOPS, 187, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina camel capucha", CLOTHES_TOPS, 188, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina camel capucha abierta", CLOTHES_TOPS, 189, SEX_MALE, 250),
            new BusinessClothesModel(0, "Jersey gris rombos negros", CLOTHES_TOPS, 190, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra y verde camuflaje abierta", CLOTHES_TOPS, 191, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina gris abierta", CLOTHES_TOPS, 192, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca letras naranja", CLOTHES_TOPS, 193, SEX_MALE, 250),
            new BusinessClothesModel(0, "Navideño", CLOTHES_TOPS, 194, SEX_MALE, 250),
            new BusinessClothesModel(0, "Jersey gris con bits amarillo", CLOTHES_TOPS, 196, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camisa azul arboles blancos", CLOTHES_TOPS, 198, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera amarilla parches naranjas capucha", CLOTHES_TOPS, 200, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta negra manga larga dibujos amarillos rojos y celeste", CLOTHES_TOPS, 201, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta negra sin manga con capucha puesta", CLOTHES_TOPS, 202, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera amarilla parche naranja capucha puesta", CLOTHES_TOPS, 203, SEX_MALE, 250),
            new BusinessClothesModel(0, "Gabardina negra larga cacpucha puesta", CLOTHES_TOPS, 204, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera sin manga cuello ancho", CLOTHES_TOPS, 205, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta sin manga camuflaje azul capucha", CLOTHES_TOPS, 206, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta sin manga camuflaje azul capucha puesta", CLOTHES_TOPS, 207, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta camuflaje azul", CLOTHES_TOPS, 208, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta larga azul camuflaje", CLOTHES_TOPS, 209, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta larga azul camuflaje capucha", CLOTHES_TOPS, 210, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta larga azul camuflaje capucha puesta", CLOTHES_TOPS, 211, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta larga abierta azul camuflaje", CLOTHES_TOPS, 212, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta negra y azul camuflaje sin manga", CLOTHES_TOPS, 213, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta negra y azul camuflaje", CLOTHES_TOPS, 214, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta azul camuflaje y negra", CLOTHES_TOPS, 215, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta sin manga azul camuflaje y negra", CLOTHES_TOPS, 216, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron larga", CLOTHES_TOPS, 217, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta marron larga capucha puesta", CLOTHES_TOPS, 218, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta sin manga azul camuflaje", CLOTHES_TOPS, 219, SEX_MALE, 250),
            new BusinessClothesModel(0, "Sudadera azul mangas azul camuflaje", CLOTHES_TOPS, 220, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta manga larga azul camuflaje", CLOTHES_TOPS, 221, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta azul camuflaje", CLOTHES_TOPS, 222, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta sin manga negra cremallera", CLOTHES_TOPS, 223, SEX_MALE, 250),
            new BusinessClothesModel(0, "Chaqueta negra cremallera", CLOTHES_TOPS, 224, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta blanca y azul oscuro 98", CLOTHES_TOPS, 225, SEX_MALE, 250),
            new BusinessClothesModel(0, "Camiseta negra normal", CLOTHES_TOPS, 226, SEX_MALE, 250),

            // Female undershirt
            new BusinessClothesModel(0, "0", CLOTHES_UNDERSHIRT, 0, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "1", CLOTHES_UNDERSHIRT, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "2", CLOTHES_UNDERSHIRT, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "3", CLOTHES_UNDERSHIRT, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "4", CLOTHES_UNDERSHIRT, 4, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "5", CLOTHES_UNDERSHIRT, 5, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "6", CLOTHES_UNDERSHIRT, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "7", CLOTHES_UNDERSHIRT, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "8", CLOTHES_UNDERSHIRT, 8, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "9", CLOTHES_UNDERSHIRT, 9, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "10", CLOTHES_UNDERSHIRT, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "11", CLOTHES_UNDERSHIRT, 11, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "12", CLOTHES_UNDERSHIRT, 12, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "13", CLOTHES_UNDERSHIRT, 13, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "14", CLOTHES_UNDERSHIRT, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "15", CLOTHES_UNDERSHIRT, 15, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "16", CLOTHES_UNDERSHIRT, 16, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "17", CLOTHES_UNDERSHIRT, 17, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "18", CLOTHES_UNDERSHIRT, 18, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "19", CLOTHES_UNDERSHIRT, 19, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "20", CLOTHES_UNDERSHIRT, 20, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "21", CLOTHES_UNDERSHIRT, 21, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "22", CLOTHES_UNDERSHIRT, 22, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "23", CLOTHES_UNDERSHIRT, 23, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "24", CLOTHES_UNDERSHIRT, 24, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "25", CLOTHES_UNDERSHIRT, 25, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "26", CLOTHES_UNDERSHIRT, 26, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "27", CLOTHES_UNDERSHIRT, 27, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "28", CLOTHES_UNDERSHIRT, 28, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "29", CLOTHES_UNDERSHIRT, 29, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "30", CLOTHES_UNDERSHIRT, 30, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "31", CLOTHES_UNDERSHIRT, 31, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "32", CLOTHES_UNDERSHIRT, 32, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "33", CLOTHES_UNDERSHIRT, 33, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "34", CLOTHES_UNDERSHIRT, 34, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "35", CLOTHES_UNDERSHIRT, 35, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "36", CLOTHES_UNDERSHIRT, 36, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "37", CLOTHES_UNDERSHIRT, 37, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "38", CLOTHES_UNDERSHIRT, 38, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "39", CLOTHES_UNDERSHIRT, 39, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "40", CLOTHES_UNDERSHIRT, 40, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "41", CLOTHES_UNDERSHIRT, 41, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "42", CLOTHES_UNDERSHIRT, 42, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "43", CLOTHES_UNDERSHIRT, 43, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "44", CLOTHES_UNDERSHIRT, 44, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "45", CLOTHES_UNDERSHIRT, 45, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "46", CLOTHES_UNDERSHIRT, 46, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "47", CLOTHES_UNDERSHIRT, 47, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "48", CLOTHES_UNDERSHIRT, 48, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "49", CLOTHES_UNDERSHIRT, 49, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "50", CLOTHES_UNDERSHIRT, 50, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "51", CLOTHES_UNDERSHIRT, 51, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "52", CLOTHES_UNDERSHIRT, 52, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "53", CLOTHES_UNDERSHIRT, 53, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "54", CLOTHES_UNDERSHIRT, 54, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "55", CLOTHES_UNDERSHIRT, 55, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "56", CLOTHES_UNDERSHIRT, 56, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "57", CLOTHES_UNDERSHIRT, 57, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "58", CLOTHES_UNDERSHIRT, 58, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "59", CLOTHES_UNDERSHIRT, 59, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "60", CLOTHES_UNDERSHIRT, 60, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "61", CLOTHES_UNDERSHIRT, 61, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "62", CLOTHES_UNDERSHIRT, 62, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "63", CLOTHES_UNDERSHIRT, 63, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "64", CLOTHES_UNDERSHIRT, 64, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "65", CLOTHES_UNDERSHIRT, 65, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "66", CLOTHES_UNDERSHIRT, 66, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "67", CLOTHES_UNDERSHIRT, 67, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "68", CLOTHES_UNDERSHIRT, 68, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "69", CLOTHES_UNDERSHIRT, 69, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "70", CLOTHES_UNDERSHIRT, 70, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "71", CLOTHES_UNDERSHIRT, 71, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "72", CLOTHES_UNDERSHIRT, 72, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "73", CLOTHES_UNDERSHIRT, 73, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "74", CLOTHES_UNDERSHIRT, 74, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "75", CLOTHES_UNDERSHIRT, 75, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "76", CLOTHES_UNDERSHIRT, 76, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "77", CLOTHES_UNDERSHIRT, 77, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "78", CLOTHES_UNDERSHIRT, 78, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "79", CLOTHES_UNDERSHIRT, 79, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "80", CLOTHES_UNDERSHIRT, 80, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "81", CLOTHES_UNDERSHIRT, 81, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "82", CLOTHES_UNDERSHIRT, 82, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "83", CLOTHES_UNDERSHIRT, 83, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "84", CLOTHES_UNDERSHIRT, 84, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "85", CLOTHES_UNDERSHIRT, 85, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "86", CLOTHES_UNDERSHIRT, 86, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "87", CLOTHES_UNDERSHIRT, 87, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "88", CLOTHES_UNDERSHIRT, 88, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "89", CLOTHES_UNDERSHIRT, 89, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "90", CLOTHES_UNDERSHIRT, 90, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "91", CLOTHES_UNDERSHIRT, 91, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "92", CLOTHES_UNDERSHIRT, 92, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "93", CLOTHES_UNDERSHIRT, 93, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "94", CLOTHES_UNDERSHIRT, 94, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "95", CLOTHES_UNDERSHIRT, 95, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "96", CLOTHES_UNDERSHIRT, 96, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "97", CLOTHES_UNDERSHIRT, 97, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "98", CLOTHES_UNDERSHIRT, 98, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "99", CLOTHES_UNDERSHIRT, 99, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "100", CLOTHES_UNDERSHIRT, 100, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "101", CLOTHES_UNDERSHIRT, 101, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "102", CLOTHES_UNDERSHIRT, 102, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "103", CLOTHES_UNDERSHIRT, 103, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "104", CLOTHES_UNDERSHIRT, 104, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "105", CLOTHES_UNDERSHIRT, 105, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "106", CLOTHES_UNDERSHIRT, 106, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "107", CLOTHES_UNDERSHIRT, 107, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "108", CLOTHES_UNDERSHIRT, 108, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "109", CLOTHES_UNDERSHIRT, 109, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "110", CLOTHES_UNDERSHIRT, 100, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "111", CLOTHES_UNDERSHIRT, 111, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "112", CLOTHES_UNDERSHIRT, 112, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "113", CLOTHES_UNDERSHIRT, 113, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "114", CLOTHES_UNDERSHIRT, 114, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "115", CLOTHES_UNDERSHIRT, 115, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "116", CLOTHES_UNDERSHIRT, 116, SEX_FEMALE, 250),
            new BusinessClothesModel(0, "117", CLOTHES_UNDERSHIRT, 117, SEX_FEMALE, 250),

            // Male undershirt
            new BusinessClothesModel(0, "0", CLOTHES_UNDERSHIRT, 0, SEX_MALE, 250),
            new BusinessClothesModel(0, "1", CLOTHES_UNDERSHIRT, 1, SEX_MALE, 250),
            new BusinessClothesModel(0, "2", CLOTHES_UNDERSHIRT, 2, SEX_MALE, 250),
            new BusinessClothesModel(0, "3", CLOTHES_UNDERSHIRT, 3, SEX_MALE, 250),
            new BusinessClothesModel(0, "4", CLOTHES_UNDERSHIRT, 4, SEX_MALE, 250),
            new BusinessClothesModel(0, "5", CLOTHES_UNDERSHIRT, 5, SEX_MALE, 250),
            new BusinessClothesModel(0, "6", CLOTHES_UNDERSHIRT, 6, SEX_MALE, 250),
            new BusinessClothesModel(0, "7", CLOTHES_UNDERSHIRT, 7, SEX_MALE, 250),
            new BusinessClothesModel(0, "8", CLOTHES_UNDERSHIRT, 8, SEX_MALE, 250),
            new BusinessClothesModel(0, "9", CLOTHES_UNDERSHIRT, 9, SEX_MALE, 250),
            new BusinessClothesModel(0, "10", CLOTHES_UNDERSHIRT, 10, SEX_MALE, 250),
            new BusinessClothesModel(0, "11", CLOTHES_UNDERSHIRT, 11, SEX_MALE, 250),
            new BusinessClothesModel(0, "12", CLOTHES_UNDERSHIRT, 12, SEX_MALE, 250),
            new BusinessClothesModel(0, "13", CLOTHES_UNDERSHIRT, 13, SEX_MALE, 250),
            new BusinessClothesModel(0, "14", CLOTHES_UNDERSHIRT, 14, SEX_MALE, 250),
            new BusinessClothesModel(0, "15", CLOTHES_UNDERSHIRT, 15, SEX_MALE, 250),
            new BusinessClothesModel(0, "16", CLOTHES_UNDERSHIRT, 16, SEX_MALE, 250),
            new BusinessClothesModel(0, "17", CLOTHES_UNDERSHIRT, 17, SEX_MALE, 250),
            new BusinessClothesModel(0, "18", CLOTHES_UNDERSHIRT, 18, SEX_MALE, 250),
            new BusinessClothesModel(0, "19", CLOTHES_UNDERSHIRT, 19, SEX_MALE, 250),
            new BusinessClothesModel(0, "20", CLOTHES_UNDERSHIRT, 20, SEX_MALE, 250),
            new BusinessClothesModel(0, "21", CLOTHES_UNDERSHIRT, 21, SEX_MALE, 250),
            new BusinessClothesModel(0, "22", CLOTHES_UNDERSHIRT, 22, SEX_MALE, 250),
            new BusinessClothesModel(0, "23", CLOTHES_UNDERSHIRT, 23, SEX_MALE, 250),
            new BusinessClothesModel(0, "24", CLOTHES_UNDERSHIRT, 24, SEX_MALE, 250),
            new BusinessClothesModel(0, "25", CLOTHES_UNDERSHIRT, 25, SEX_MALE, 250),
            new BusinessClothesModel(0, "26", CLOTHES_UNDERSHIRT, 26, SEX_MALE, 250),
            new BusinessClothesModel(0, "27", CLOTHES_UNDERSHIRT, 27, SEX_MALE, 250),
            new BusinessClothesModel(0, "28", CLOTHES_UNDERSHIRT, 28, SEX_MALE, 250),
            new BusinessClothesModel(0, "29", CLOTHES_UNDERSHIRT, 29, SEX_MALE, 250),
            new BusinessClothesModel(0, "30", CLOTHES_UNDERSHIRT, 30, SEX_MALE, 250),
            new BusinessClothesModel(0, "31", CLOTHES_UNDERSHIRT, 31, SEX_MALE, 250),
            new BusinessClothesModel(0, "32", CLOTHES_UNDERSHIRT, 32, SEX_MALE, 250),
            new BusinessClothesModel(0, "33", CLOTHES_UNDERSHIRT, 33, SEX_MALE, 250),
            new BusinessClothesModel(0, "34", CLOTHES_UNDERSHIRT, 34, SEX_MALE, 250),
            new BusinessClothesModel(0, "35", CLOTHES_UNDERSHIRT, 35, SEX_MALE, 250),
            new BusinessClothesModel(0, "36", CLOTHES_UNDERSHIRT, 36, SEX_MALE, 250),
            new BusinessClothesModel(0, "37", CLOTHES_UNDERSHIRT, 37, SEX_MALE, 250),
            new BusinessClothesModel(0, "38", CLOTHES_UNDERSHIRT, 38, SEX_MALE, 250),
            new BusinessClothesModel(0, "39", CLOTHES_UNDERSHIRT, 39, SEX_MALE, 250),
            new BusinessClothesModel(0, "40", CLOTHES_UNDERSHIRT, 40, SEX_MALE, 250),
            new BusinessClothesModel(0, "41", CLOTHES_UNDERSHIRT, 41, SEX_MALE, 250),
            new BusinessClothesModel(0, "42", CLOTHES_UNDERSHIRT, 42, SEX_MALE, 250),
            new BusinessClothesModel(0, "43", CLOTHES_UNDERSHIRT, 43, SEX_MALE, 250),
            new BusinessClothesModel(0, "44", CLOTHES_UNDERSHIRT, 44, SEX_MALE, 250),
            new BusinessClothesModel(0, "45", CLOTHES_UNDERSHIRT, 45, SEX_MALE, 250),
            new BusinessClothesModel(0, "46", CLOTHES_UNDERSHIRT, 46, SEX_MALE, 250),
            new BusinessClothesModel(0, "47", CLOTHES_UNDERSHIRT, 47, SEX_MALE, 250),
            new BusinessClothesModel(0, "48", CLOTHES_UNDERSHIRT, 48, SEX_MALE, 250),
            new BusinessClothesModel(0, "49", CLOTHES_UNDERSHIRT, 49, SEX_MALE, 250),
            new BusinessClothesModel(0, "50", CLOTHES_UNDERSHIRT, 50, SEX_MALE, 250),
            new BusinessClothesModel(0, "51", CLOTHES_UNDERSHIRT, 51, SEX_MALE, 250),
            new BusinessClothesModel(0, "52", CLOTHES_UNDERSHIRT, 52, SEX_MALE, 250),
            new BusinessClothesModel(0, "53", CLOTHES_UNDERSHIRT, 53, SEX_MALE, 250),
            new BusinessClothesModel(0, "54", CLOTHES_UNDERSHIRT, 54, SEX_MALE, 250),
            new BusinessClothesModel(0, "55", CLOTHES_UNDERSHIRT, 55, SEX_MALE, 250),
            new BusinessClothesModel(0, "56", CLOTHES_UNDERSHIRT, 56, SEX_MALE, 250),
            new BusinessClothesModel(0, "57", CLOTHES_UNDERSHIRT, 57, SEX_MALE, 250),
            new BusinessClothesModel(0, "58", CLOTHES_UNDERSHIRT, 58, SEX_MALE, 250),
            new BusinessClothesModel(0, "59", CLOTHES_UNDERSHIRT, 59, SEX_MALE, 250),
            new BusinessClothesModel(0, "60", CLOTHES_UNDERSHIRT, 60, SEX_MALE, 250),
            new BusinessClothesModel(0, "61", CLOTHES_UNDERSHIRT, 61, SEX_MALE, 250),
            new BusinessClothesModel(0, "62", CLOTHES_UNDERSHIRT, 62, SEX_MALE, 250),
            new BusinessClothesModel(0, "63", CLOTHES_UNDERSHIRT, 63, SEX_MALE, 250),
            new BusinessClothesModel(0, "64", CLOTHES_UNDERSHIRT, 64, SEX_MALE, 250),
            new BusinessClothesModel(0, "65", CLOTHES_UNDERSHIRT, 65, SEX_MALE, 250),
            new BusinessClothesModel(0, "66", CLOTHES_UNDERSHIRT, 66, SEX_MALE, 250),
            new BusinessClothesModel(0, "67", CLOTHES_UNDERSHIRT, 67, SEX_MALE, 250),
            new BusinessClothesModel(0, "68", CLOTHES_UNDERSHIRT, 68, SEX_MALE, 250),
            new BusinessClothesModel(0, "69", CLOTHES_UNDERSHIRT, 69, SEX_MALE, 250),
            new BusinessClothesModel(0, "70", CLOTHES_UNDERSHIRT, 70, SEX_MALE, 250),
            new BusinessClothesModel(0, "71", CLOTHES_UNDERSHIRT, 71, SEX_MALE, 250),
            new BusinessClothesModel(0, "72", CLOTHES_UNDERSHIRT, 72, SEX_MALE, 250),
            new BusinessClothesModel(0, "73", CLOTHES_UNDERSHIRT, 73, SEX_MALE, 250),
            new BusinessClothesModel(0, "74", CLOTHES_UNDERSHIRT, 74, SEX_MALE, 250),
            new BusinessClothesModel(0, "75", CLOTHES_UNDERSHIRT, 75, SEX_MALE, 250),
            new BusinessClothesModel(0, "76", CLOTHES_UNDERSHIRT, 76, SEX_MALE, 250),
            new BusinessClothesModel(0, "77", CLOTHES_UNDERSHIRT, 77, SEX_MALE, 250),
            new BusinessClothesModel(0, "78", CLOTHES_UNDERSHIRT, 78, SEX_MALE, 250),
            new BusinessClothesModel(0, "79", CLOTHES_UNDERSHIRT, 79, SEX_MALE, 250),
            new BusinessClothesModel(0, "80", CLOTHES_UNDERSHIRT, 80, SEX_MALE, 250),
            new BusinessClothesModel(0, "81", CLOTHES_UNDERSHIRT, 81, SEX_MALE, 250),
            new BusinessClothesModel(0, "82", CLOTHES_UNDERSHIRT, 82, SEX_MALE, 250),
            new BusinessClothesModel(0, "83", CLOTHES_UNDERSHIRT, 83, SEX_MALE, 250),
            new BusinessClothesModel(0, "84", CLOTHES_UNDERSHIRT, 84, SEX_MALE, 250),
            new BusinessClothesModel(0, "85", CLOTHES_UNDERSHIRT, 85, SEX_MALE, 250),
            new BusinessClothesModel(0, "86", CLOTHES_UNDERSHIRT, 86, SEX_MALE, 250),
            new BusinessClothesModel(0, "87", CLOTHES_UNDERSHIRT, 87, SEX_MALE, 250),
            new BusinessClothesModel(0, "88", CLOTHES_UNDERSHIRT, 88, SEX_MALE, 250),
            new BusinessClothesModel(0, "89", CLOTHES_UNDERSHIRT, 89, SEX_MALE, 250),
            new BusinessClothesModel(0, "90", CLOTHES_UNDERSHIRT, 90, SEX_MALE, 250),
            new BusinessClothesModel(0, "91", CLOTHES_UNDERSHIRT, 91, SEX_MALE, 250),
            new BusinessClothesModel(0, "92", CLOTHES_UNDERSHIRT, 92, SEX_MALE, 250),
            new BusinessClothesModel(0, "93", CLOTHES_UNDERSHIRT, 93, SEX_MALE, 250),
            new BusinessClothesModel(0, "94", CLOTHES_UNDERSHIRT, 94, SEX_MALE, 250),
            new BusinessClothesModel(0, "95", CLOTHES_UNDERSHIRT, 95, SEX_MALE, 250),
            new BusinessClothesModel(0, "96", CLOTHES_UNDERSHIRT, 96, SEX_MALE, 250),
            new BusinessClothesModel(0, "97", CLOTHES_UNDERSHIRT, 97, SEX_MALE, 250),

            // Female hats
            new BusinessClothesModel(1, "Auriculares rojos", ACCESSORY_HATS, 0, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Cono blanco", ACCESSORY_HATS, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Cowgirl cuadros negro y blanco", ACCESSORY_HATS, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Achatado cuadros negro y blanco", ACCESSORY_HATS, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra negra Los Santos", ACCESSORY_HATS, 4, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Lana negro", ACCESSORY_HATS, 5, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra negra", ACCESSORY_HATS, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Achatado azul oscuro", ACCESSORY_HATS, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Cuadros negros y blanco", ACCESSORY_HATS, 8, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra negra y blanca Fruit", ACCESSORY_HATS, 9, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra cuadros negro y blanco", ACCESSORY_HATS, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pamela cuadros negro y blanco", ACCESSORY_HATS, 11, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Lana negro", ACCESSORY_HATS, 12, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Marron claro y marron oscuro", ACCESSORY_HATS, 13, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pintor negro", ACCESSORY_HATS, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Auriculares blanco", ACCESSORY_HATS, 15, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco amarillo rojo y negro", ACCESSORY_HATS, 16, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco abierto azul y negro", ACCESSORY_HATS, 17, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco negro", ACCESSORY_HATS, 18, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Camel", ACCESSORY_HATS, 20, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Achatado rosa con cinta", ACCESSORY_HATS, 21, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pamela marron claro", ACCESSORY_HATS, 22, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Papa noel", ACCESSORY_HATS, 23, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Duende", ACCESSORY_HATS, 24, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Reno", ACCESSORY_HATS, 25, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Negro chaplin", ACCESSORY_HATS, 26, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Negro copa", ACCESSORY_HATS, 27, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Marron", ACCESSORY_HATS, 28, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Lila", ACCESSORY_HATS, 29, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Choose you primero", ACCESSORY_HATS, 30, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Choose you segundo", ACCESSORY_HATS, 31, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Choose you tercero", ACCESSORY_HATS, 32, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Capitan america", ACCESSORY_HATS, 33, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Reina patriota", ACCESSORY_HATS, 34, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Estrellas EEUU", ACCESSORY_HATS, 35, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Corra con cerveza", ACCESSORY_HATS, 36, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco caballo", ACCESSORY_HATS, 38, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Arbol navidad", ACCESSORY_HATS, 39, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Postre", ACCESSORY_HATS, 40, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Navideño", ACCESSORY_HATS, 41, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Mama noel", ACCESSORY_HATS, 42, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra Naughty", ACCESSORY_HATS, 43, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra hacia atras roja", ACCESSORY_HATS, 44, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco visera negro", ACCESSORY_HATS, 47, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco negro opaco", ACCESSORY_HATS, 49, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco negro espejo", ACCESSORY_HATS, 50, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra verde simbolo", ACCESSORY_HATS, 53, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pamela marron clarito", ACCESSORY_HATS, 54, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra roja y azul", ACCESSORY_HATS, 55, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra negra Magretics", ACCESSORY_HATS, 56, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra marron clarito", ACCESSORY_HATS, 58, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco caballo verde", ACCESSORY_HATS, 59, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Lana verde", ACCESSORY_HATS, 60, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Negro y verde", ACCESSORY_HATS, 61, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco verde", ACCESSORY_HATS, 62, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra verde", ACCESSORY_HATS, 63, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra negra triangulo rojo y blanco", ACCESSORY_HATS, 64, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra negra hacia atras", ACCESSORY_HATS, 65, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco oscuro abierta visera", ACCESSORY_HATS, 66, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco negro abierta visera", ACCESSORY_HATS, 67, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco negro visera espejo abierta", ACCESSORY_HATS, 68, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco verde visera abierta", ACCESSORY_HATS, 71, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco verde abierto", ACCESSORY_HATS, 74, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra amarilla y azul", ACCESSORY_HATS, 75, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra hacia atras azul", ACCESSORY_HATS, 76, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Achatado negro", ACCESSORY_HATS, 82, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco guerra con pinchos", ACCESSORY_HATS, 83, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco guerra negro", ACCESSORY_HATS, 84, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco cresta", ACCESSORY_HATS, 86, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco trinchera", ACCESSORY_HATS, 88, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco trinchera plata", ACCESSORY_HATS, 89, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco negro rayas amarillas", ACCESSORY_HATS, 90, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco negro rayas amarillas visera abierta", ACCESSORY_HATS, 91, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Casco abierto blanco y azul", ACCESSORY_HATS, 92, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Achatado marron claro", ACCESSORY_HATS, 93, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Normal negro y camel", ACCESSORY_HATS, 94, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra negra Bigness", ACCESSORY_HATS, 95, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Cuernos reno punta roja", ACCESSORY_HATS, 100, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Gorra negra", ACCESSORY_HATS, 101, SEX_FEMALE, 250),

            // Male hats
            new BusinessClothesModel(1, "Auriculares rojos", ACCESSORY_HATS, 0, SEX_MALE, 250),
            new BusinessClothesModel(1, "Cono blanco", ACCESSORY_HATS, 1, SEX_MALE, 250),
            new BusinessClothesModel(1, "Lana negro", ACCESSORY_HATS, 2, SEX_MALE, 250),
            new BusinessClothesModel(1, "Michael cuadros negros y blanco", ACCESSORY_HATS, 3, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra negra LS", ACCESSORY_HATS, 4, SEX_MALE, 250),
            new BusinessClothesModel(1, "Lana negro achatado", ACCESSORY_HATS, 5, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra verde", ACCESSORY_HATS, 6, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorrilla blanca", ACCESSORY_HATS, 7, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra hacia atras cuadrados negros y blancos", ACCESSORY_HATS, 9, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra cuadrados negros y blancos", ACCESSORY_HATS, 10, SEX_MALE, 250),
            new BusinessClothesModel(1, "Grande negro con cinta", ACCESSORY_HATS, 12, SEX_MALE, 250),
            new BusinessClothesModel(1, "Cowboy negro", ACCESSORY_HATS, 13, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pañuelo blanco motivos negros", ACCESSORY_HATS, 14, SEX_MALE, 250),
            new BusinessClothesModel(1, "Auriculares blancos", ACCESSORY_HATS, 15, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco amarillo negro y rojo", ACCESSORY_HATS, 16, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco abierto azul y negro", ACCESSORY_HATS, 17, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco negro", ACCESSORY_HATS, 18, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pesquero verde", ACCESSORY_HATS, 20, SEX_MALE, 250),
            new BusinessClothesModel(1, "Sombrerillo canera", ACCESSORY_HATS, 21, SEX_MALE, 250),
            new BusinessClothesModel(1, "Papa noel", ACCESSORY_HATS, 22, SEX_MALE, 250),
            new BusinessClothesModel(1, "Duende navidad", ACCESSORY_HATS, 23, SEX_MALE, 250),
            new BusinessClothesModel(1, "Reno", ACCESSORY_HATS, 24, SEX_MALE, 250),
            new BusinessClothesModel(1, "Negro oscuro con cinta", ACCESSORY_HATS, 25, SEX_MALE, 250),
            new BusinessClothesModel(1, "Chaplin negro", ACCESSORY_HATS, 26, SEX_MALE, 250),
            new BusinessClothesModel(1, "Copa negro", ACCESSORY_HATS, 27, SEX_MALE, 250),
            new BusinessClothesModel(1, "Lana azul", ACCESSORY_HATS, 28, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pequeño gris", ACCESSORY_HATS, 29, SEX_MALE, 250),
            new BusinessClothesModel(1, "Grande rojo cinta negra", ACCESSORY_HATS, 30, SEX_MALE, 250),
            new BusinessClothesModel(1, "Choose you primero", ACCESSORY_HATS, 31, SEX_MALE, 250),
            new BusinessClothesModel(1, "Choose you segundo", ACCESSORY_HATS, 32, SEX_MALE, 250),
            new BusinessClothesModel(1, "Choose you tercero", ACCESSORY_HATS, 33, SEX_MALE, 250),
            new BusinessClothesModel(1, "Lana capitan america", ACCESSORY_HATS, 34, SEX_MALE, 250),
            new BusinessClothesModel(1, "Reina america", ACCESSORY_HATS, 35, SEX_MALE, 250),
            new BusinessClothesModel(1, "Estrellas EEUU", ACCESSORY_HATS, 36, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra con cerveza", ACCESSORY_HATS, 37, SEX_MALE, 250),
            new BusinessClothesModel(1, "Negro caballo", ACCESSORY_HATS, 39, SEX_MALE, 250),
            new BusinessClothesModel(1, "Arbol navidad", ACCESSORY_HATS, 40, SEX_MALE, 250),
            new BusinessClothesModel(1, "Postre", ACCESSORY_HATS, 41, SEX_MALE, 250),
            new BusinessClothesModel(1, "Navideño", ACCESSORY_HATS, 42, SEX_MALE, 250),
            new BusinessClothesModel(1, "Papa noel a cuadros", ACCESSORY_HATS, 43, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra roja y blanca con letras", ACCESSORY_HATS, 44, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra hacia atras roja", ACCESSORY_HATS, 45, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco visera hacia delante negro", ACCESSORY_HATS, 48, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco negro opaco", ACCESSORY_HATS, 50, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco negro visera espejo", ACCESSORY_HATS, 51, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra verde letra", ACCESSORY_HATS, 54, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra roja y azul con letras", ACCESSORY_HATS, 55, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra negra con letras doradas", ACCESSORY_HATS, 56, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra maron", ACCESSORY_HATS, 58, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco caballo verde", ACCESSORY_HATS, 59, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra verde", ACCESSORY_HATS, 60, SEX_MALE, 250),
            new BusinessClothesModel(1, "Grance negro cinta verde", ACCESSORY_HATS, 61, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco verde", ACCESSORY_HATS, 62, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra verde lisa", ACCESSORY_HATS, 63, SEX_MALE, 250),
            new BusinessClothesModel(1, "Grande azul oscuro con rayas", ACCESSORY_HATS, 64, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra negra triangulo rojo y blanco", ACCESSORY_HATS, 65, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra negra hacia atras", ACCESSORY_HATS, 66, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco negro visera abierta", ACCESSORY_HATS, 67, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco negro visera opaca abierta", ACCESSORY_HATS, 68, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco negro visera espejo abierta", ACCESSORY_HATS, 69, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco abierto verde", ACCESSORY_HATS, 75, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra azul y amarilla con letras", ACCESSORY_HATS, 76, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra azul hacia atras", ACCESSORY_HATS, 77, SEX_MALE, 250),
            new BusinessClothesModel(1, "Lana negra", ACCESSORY_HATS, 83, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco guerra pinchos", ACCESSORY_HATS, 84, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco guerra", ACCESSORY_HATS, 85, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco guerra visera", ACCESSORY_HATS, 86, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco guerra cresta", ACCESSORY_HATS, 87, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco guerra negro", ACCESSORY_HATS, 89, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco guerra plata", ACCESSORY_HATS, 90, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco negro rayas amarillas", ACCESSORY_HATS, 91, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco negro rayas amarillas visera abierta", ACCESSORY_HATS, 92, SEX_MALE, 250),
            new BusinessClothesModel(1, "Casco abierto blanco con diana", ACCESSORY_HATS, 93, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pescador camel", ACCESSORY_HATS, 94, SEX_MALE, 250),
            new BusinessClothesModel(1, "Michael negro cinta camel", ACCESSORY_HATS, 95, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra negra BIGNESS", ACCESSORY_HATS, 96, SEX_MALE, 250),
            new BusinessClothesModel(1, "Reno puntas rojas", ACCESSORY_HATS, 101, SEX_MALE, 250),
            new BusinessClothesModel(1, "Gorra negra basica", ACCESSORY_HATS, 102, SEX_MALE, 250),

            // Female glasses
            new BusinessClothesModel(1, "Deportiva cristal amarillo naranja", ACCESSORY_GLASSES, 0, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Redondas marron oscuro", ACCESSORY_GLASSES, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Redonda con picos superiores marron oscuro", ACCESSORY_GLASSES, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Rectas cristal marron", ACCESSORY_GLASSES, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Redondas pico superior leopardo", ACCESSORY_GLASSES, 4, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Redonda negra patillas plata", ACCESSORY_GLASSES, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Ovaladas cristal opaco marron", ACCESSORY_GLASSES, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pasta cristal marron transparente", ACCESSORY_GLASSES, 8, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Deportiva cristal amarillo", ACCESSORY_GLASSES, 9, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Deportiva cristal de amarillo a azul", ACCESSORY_GLASSES, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Aviador plata cristal oscuro", ACCESSORY_GLASSES, 11, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Vista pasta negra cristal transparente", ACCESSORY_GLASSES, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Redonda marron oscuro patillas oro", ACCESSORY_GLASSES, 16, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pasta negra cristal transparente", ACCESSORY_GLASSES, 17, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Finas oro cristal negro", ACCESSORY_GLASSES, 18, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Finas negro cristal negro", ACCESSORY_GLASSES, 19, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Redondas negras cristal transparente oscuro", ACCESSORY_GLASSES, 20, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Redonda negra cristal transparente", ACCESSORY_GLASSES, 21, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Estrellas EEUU", ACCESSORY_GLASSES, 22, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Cuadradas estrellas azul y blanco", ACCESSORY_GLASSES, 23, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Cuadradas negra cristal oscuro", ACCESSORY_GLASSES, 24, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Deportiva verde cristal oscuro", ACCESSORY_GLASSES, 25, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Piloto", ACCESSORY_GLASSES, 26, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Snow", ACCESSORY_GLASSES, 27, SEX_FEMALE, 250),

            // Male glasses
            new BusinessClothesModel(1, "Finas cuadrados blancos y negros", ACCESSORY_GLASSES, 1, SEX_MALE, 250),
            new BusinessClothesModel(1, "Finas negra cristal oscuro", ACCESSORY_GLASSES, 2, SEX_MALE, 250),
            new BusinessClothesModel(1, "Finas negras cristal transparente oscuro", ACCESSORY_GLASSES, 3, SEX_MALE, 250),
            new BusinessClothesModel(1, "Finas negrasl cristal transparente", ACCESSORY_GLASSES, 4, SEX_MALE, 250),
            new BusinessClothesModel(1, "Aviador dorado", ACCESSORY_GLASSES, 5, SEX_MALE, 250),
            new BusinessClothesModel(1, "Aviador plata", ACCESSORY_GLASSES, 8, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pasta negra cristal negro", ACCESSORY_GLASSES, 9, SEX_MALE, 250),
            new BusinessClothesModel(1, "Cuadrada negra superior oro", ACCESSORY_GLASSES, 10, SEX_MALE, 250),
            new BusinessClothesModel(1, "Aviador oro cristal marron", ACCESSORY_GLASSES, 12, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pasta negra cristal rojo", ACCESSORY_GLASSES, 13, SEX_MALE, 250),
            new BusinessClothesModel(1, "Deportiva cristal amarillo", ACCESSORY_GLASSES, 15, SEX_MALE, 250),
            new BusinessClothesModel(1, "Deportiva negra cristal rojo", ACCESSORY_GLASSES, 16, SEX_MALE, 250),
            new BusinessClothesModel(1, "Fina blanca cristal gris", ACCESSORY_GLASSES, 17, SEX_MALE, 250),
            new BusinessClothesModel(1, "Cuadrada oro cristal oscuro", ACCESSORY_GLASSES, 18, SEX_MALE, 250),
            new BusinessClothesModel(1, "Cuadrada pasta negra superior oro", ACCESSORY_GLASSES, 19, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pasta negra cristal transparente", ACCESSORY_GLASSES, 20, SEX_MALE, 250),
            new BusinessClothesModel(1, "Estrellas EEUU", ACCESSORY_GLASSES, 21, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pasta azul y estrellas blancas", ACCESSORY_GLASSES, 22, SEX_MALE, 250),
            new BusinessClothesModel(1, "Deportiva verde cristal negro", ACCESSORY_GLASSES, 23, SEX_MALE, 250),
            new BusinessClothesModel(1, "Piloto", ACCESSORY_GLASSES, 24, SEX_MALE, 250),
            new BusinessClothesModel(1, "Snow", ACCESSORY_GLASSES, 25, SEX_MALE, 250),

            // Female earrings
            new BusinessClothesModel(1, "Pinganillo negro y blanco", ACCESSORY_EARS, 0, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pinganillo rojo y negro", ACCESSORY_EARS, 1, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pinganillo rectangular negro", ACCESSORY_EARS, 2, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pendiente largo plata", ACCESSORY_EARS, 3, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pendiente marron caro", ACCESSORY_EARS, 4, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pendiente plata", ACCESSORY_EARS, 5, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Largo rombo oro", ACCESSORY_EARS, 6, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Largo oro", ACCESSORY_EARS, 7, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Largo bolitas oro", ACCESSORY_EARS, 8, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Cortina oro", ACCESSORY_EARS, 9, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Largo bolita verde", ACCESSORY_EARS, 10, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Largo oro", ACCESSORY_EARS, 11, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Pequeñito", ACCESSORY_EARS, 12, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Aro arma oro", ACCESSORY_EARS, 13, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Aro ancho oro", ACCESSORY_EARS, 14, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Aro fino oro", ACCESSORY_EARS, 15, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Aro ancho oro letras", ACCESSORY_EARS, 16, SEX_FEMALE, 250),
            new BusinessClothesModel(1, "Aro ancho oro letras", ACCESSORY_EARS, 17, SEX_FEMALE, 250),

            // Male earrings
            new BusinessClothesModel(1, "Pinganillo negro y blanco", ACCESSORY_EARS, 0, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pinganillo rojo y negro", ACCESSORY_EARS, 1, SEX_MALE, 250),
            new BusinessClothesModel(1, "Aro pequeño oro", ACCESSORY_EARS, 4, SEX_MALE, 250),
            new BusinessClothesModel(1, "Circulo oro pequeño", ACCESSORY_EARS, 7, SEX_MALE, 250),
            new BusinessClothesModel(1, "Piramide oro", ACCESSORY_EARS, 10, SEX_MALE, 250),
            new BusinessClothesModel(1, "Cuadrado oro", ACCESSORY_EARS, 13, SEX_MALE, 250),
            new BusinessClothesModel(1, "Diamante", ACCESSORY_EARS, 16, SEX_MALE, 250),
            new BusinessClothesModel(1, "Espino", ACCESSORY_EARS, 22, SEX_MALE, 250),
            new BusinessClothesModel(1, "Calavera plata", ACCESSORY_EARS, 25, SEX_MALE, 250),
            new BusinessClothesModel(1, "Pincho metal", ACCESSORY_EARS, 28, SEX_MALE, 250),
            new BusinessClothesModel(1, "Cuadrado pequeño negro", ACCESSORY_EARS, 31, SEX_MALE, 250),
            new BusinessClothesModel(1, "Cuadrado grande plata", ACCESSORY_EARS, 35, SEX_MALE, 250)
        };
